...
# show_hide_helmet_view = (
    ...
    # [
		...
		# (troop_get_inventory_slot, ":cur_helmet", "trp_player", 4), # 
		  # (ge, ":cur_helmet", 0), # 
	   # (multiplayer_send_int_to_server,multiplayer_event_presentation_at_player, "prsnt_helmet_view"), 		  
      # ])	
	  
show_hide_helmet_view_sp = (
...
raw_skirmisher_javelin = (ti_on_agent_spawn, 0.1, 0, [
...
raw_skirmisher_javelin_2 = (ti_on_item_wielded, 0, 0, [
   ...
   (eq, "$g_javelin_script", 1),	   
	...
	(try_begin),		
		...
		(this_or_next|eq, ":item", "itm_w_celtic_javelin"),	
		(this_or_next|eq, ":item", "itm_javelin"),		
		(this_or_next|eq, ":item", "itm_roman_w_verutum_2pack"),			
...
dplmc_death_camera = (
  ...
  [(eq, "$g_dplmc_battle_continuation", 0),
   ...
   (eq, "$g_dplmc_cam_activated", 1),
	  ...
	  # (this_or_next|neq, "$enable_bodysliding", 1),
	  (neq, "$enable_bodysliding", BODYSLIDING_ALL_TROOPS),	  
	  ## WINDYPLAINS- ##   
  ],
  [
...
custom_commander_critical_strike_sp =(
  ti_on_agent_hit, 0, 0, [],
    [
        ...
        (try_begin), 	    
          ...
          (try_begin),
            ...
            # (try_begin),
              ...
              # (display_message, "@Delivered {reg1} extra damage from behind!", 0x3AD54F),
            # (else_try),
...
dedal_tavern_animations = (
	ti_on_agent_spawn,1,0,[
		...
		(try_begin),
			...
			(try_begin),
				(agent_has_item_equipped,":agent","itm_duduk"),
				(agent_set_stand_animation, ":agent", "anim_duduk_sitting_anim"),
				(agent_set_animation, ":agent", "anim_duduk_sitting_anim"),
				(agent_play_sound,":agent","snd_duduk_loop"),
		...
		(else_try),
			...
			(try_begin),
				(agent_has_item_equipped,":agent","itm_duduk"),
				(agent_set_stand_animation, ":agent", "anim_duduk_play"),
				(agent_set_animation, ":agent", "anim_duduk_play"),
				(agent_play_sound,":agent","snd_duduk_loop"),
			(else_try),
				(agent_has_item_equipped,":agent","itm_dedal_lira"),
  ...
  (try_for_agents, ":agent_no"),	
	...
	(try_begin), 
	    (eq, ":id", "trp_sp_roman_cornicem"),	
            ...
            (agent_get_wielded_item, ":cur_wielded_item", ":agent_no", 0),
...
# Windyplains and DrThomas Bodysliding
...
raw_warcry_sp = (0, 0, 7, [(key_clicked, key_b)], 
                             
        [
          (get_player_agent_no, ":player"),
		  (agent_is_active, ":player"),		  
          (agent_is_alive, ":player"),		  
          # (agent_get_horse, ":my_horse", ":player"),		  
          # (eq, ":my_horse", -1),	
		  (agent_set_animation,":player","anim_taunt", 1),		  
...
raw_warcry = (0, 0, 7, [(key_clicked, key_b)], 
        ...
        [
          ...
          (agent_get_horse, ":my_horse", ":player"),		  
          (eq, ":my_horse", -1),	
	      (agent_get_troop_id, ":id", ":player"),
		  
    (try_begin),		
       (this_or_next|eq,":id","trp_roman_centurio"),	 
       (this_or_next|eq,":id","trp_roman_consul"),	 
       (this_or_next|eq,":id","trp_greek_lochagos"),	 
       (this_or_next|eq,":id","trp_greek_strategos"),	 
       (this_or_next|eq,":id","trp_celtic_ariomaros"),	 
       (this_or_next|eq,":id","trp_celtic_rix"),	 
       (this_or_next|eq,":id","trp_makedonian_lochagos"),	 
       (this_or_next|eq,":id","trp_makedonian_strategos"),	 
       (this_or_next|eq,":id","trp_samnite_meddix"),	 
       (this_or_next|eq,":id","trp_samnite_meddix_touticus"),	 
       (this_or_next|eq,":id","trp_taras_lochagos"),	 
       (this_or_next|eq,":id","trp_taras_strategos"),	 
       (this_or_next|eq,":id","trp_syracusan_lochagos"),	 
       (this_or_next|eq,":id","trp_syracusan_strategos"),	 
       (this_or_next|eq,":id","trp_epeiros_lochagos"),	 
       (this_or_next|eq,":id","trp_epeiros_strategos"),	 
       (this_or_next|eq,":id","trp_etruscan_velthinei"),	 
       (eq,":id","trp_etruscan_purthsvana"),	 	   
		(multiplayer_send_int_to_server,multiplayer_event_sound_at_player, "snd_officer_order"),
		(multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_order_charge"),  
    (else_try),		
...
raw_light_instruments = (0, 0, 25, [(key_clicked, key_q)], 
        ...
        [
          ...
          (agent_is_alive, ":player"),		
              ...
              (this_or_next|eq,":wielded","itm_horn_s"),		
              (eq,":wielded","itm_horn_d"),				      			  
			(multiplayer_send_int_to_server,multiplayer_event_sound_at_player, "snd_carnyx"),
			(multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_horn_play"),  
	    	     (try_end),   
	
               (try_begin),		  
                     (agent_get_wielded_item, ":wielded",":player", 0),
              (this_or_next|eq,":wielded","itm_f_trumpet"),
              (eq,":wielded","itm_f_trumpet_dr"),				  
   			  
			(multiplayer_send_int_to_server,multiplayer_event_sound_at_player, "snd_trumpet"),
			(multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_trumpet_play"),  
	    	     (try_end),
        ])		

raw_cornu = (0, 0, 25, [(key_clicked, key_q)], 
        ...
        [
          ...
          (eq, ":my_horse", -1),	
               ...
               (try_begin),		  
                     (agent_get_wielded_item, ":wielded",":player", 0),
              (this_or_next|eq,":wielded","itm_f_cornu"),		
              (eq,":wielded","itm_horn_d"),				      			  
			(multiplayer_send_int_to_server,multiplayer_event_sound_at_player, "snd_cornu"),
			(multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_cornu_play"),  
	    	     (try_end),   

               (try_begin),		  
                     (agent_get_wielded_item, ":wielded",":player", 0),
              (this_or_next|eq,":wielded","itm_celtic_carnyx"),		
              (eq,":wielded","itm_horn_d"),				      			  
			(multiplayer_send_int_to_server,multiplayer_event_sound_at_player, "snd_carnyx"),
			(multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_carnyx"),  
	    	     (try_end),   					 
        ])			
raw_banner_taunt = (0, 0, 25, [(key_clicked, key_q)], 
    ...
    (try_begin),		
	   (agent_get_troop_id, ":id", ":player"),	
       (this_or_next|eq,":id","trp_roman_vexillarius"),	   
       (this_or_next|eq,":id","trp_greek_semaiophoros"),	 
       (this_or_next|eq,":id","trp_celtic_signifer"),	 
       (this_or_next|eq,":id","trp_makedonian_semaphoros"),
       (this_or_next|eq,":id","trp_samnite_vexillarivs"),
       (this_or_next|eq,":id","trp_taras_semaiophoros"),
       (this_or_next|eq,":id","trp_syracusan_semaiophoros"),	   
       (eq,":id","trp_epeiros_semaphoros"),	 
	   
       (agent_get_wielded_item, ":wielded",":player", 0),
					 
              (this_or_next|eq,":wielded","itm_roman_vex"),	
              (this_or_next|eq,":wielded","itm_samnite_vex"),				  
              (this_or_next|eq,":wielded","itm_mak_sema"),	
              (this_or_next|eq,":wielded","itm_mak_sema_flag"),	
              (this_or_next|eq,":wielded","itm_st_bi_mak"),				  
              (this_or_next|eq,":wielded","itm_greek_sema_athens"),	
              (this_or_next|eq,":wielded","itm_greek_sema_gorgon"),	
              (this_or_next|eq,":wielded","itm_greek_sema_medusa"),		
              (this_or_next|eq,":wielded","itm_greek_sema_syracuse"),
              (this_or_next|eq,":wielded","itm_st_taras"),				  
              (this_or_next|eq,":wielded","itm_roman_standard_legio_7"),	
              (this_or_next|eq,":wielded","itm_roman_standard_legio_5"),	
              (this_or_next|eq,":wielded","itm_roman_standard_legio_3"),	
              (this_or_next|eq,":wielded","itm_roman_standard_legio_4"),	
			  (this_or_next|eq,":wielded","itm_roman_standard_legio_16"),	
			  (this_or_next|eq,":wielded","itm_roman_standard_legio_2"),
			  (this_or_next|eq,":wielded","itm_roman_standard_legio_1_consularis"),
			  (this_or_next|eq,":wielded","itm_roman_standard_legio_2_consularis"),
			  (this_or_next|eq,":wielded","itm_roman_standard_legio_3_consularis"),
			  (this_or_next|eq,":wielded","itm_roman_standard_legio_4_consularis"),		
			  (this_or_next|eq,":wielded","itm_st_epirus_standard_flag"),	
			  (this_or_next|eq,":wielded","itm_st_epirus_standard_flag_2"),				  
			  (eq,":wielded","itm_celtic_standard"),
		  # (agent_get_position,pos6,":player"),
		  # (agent_get_team, ":wielder_team", ":player"),
		  # (assign, ":heal_count", 0),
		  # (try_for_agents,":agent"),
			  # (agent_is_alive,":agent"),    
			  # (agent_get_team, ":target_team", ":agent"),
			  # (eq, ":target_team", ":wielder_team"),
                   # (agent_set_slot,":agent", slot_agent_has_been_healed, 0),
			...
			(multiplayer_send_int_to_server,multiplayer_event_sound_at_player_2, "snd_man_yell_banner"),
			(multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_banner_taunt"),       
        ])			

raw_testudo = (0, 0, 2, [(key_clicked, key_c)],
  [(get_player_agent_no, ":agent_no"),
   ...
   (le, ":horse", 0),
    ...
    (agent_get_wielded_item, ":wielded",":agent_no", 1), 
              (this_or_next|eq,":wielded","itm_sp_triarius_scutum"),		
              (this_or_next|eq,":wielded","itm_sp_triarius_scutum_red"),		
              (this_or_next|eq,":wielded","itm_sp_triarius_scutum_blue"),		
              (this_or_next|eq,":wielded","itm_sp_triarius_scutum_white"),		
              (this_or_next|eq,":wielded","itm_sp_triarius_scutum_light_brown"),				
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_1"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_2"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_3"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_4"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_5"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_boss_1"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_boss_2"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_boss_3"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_boss_4"),		
              (this_or_next|eq,":wielded","itm_sp_hastati_scutum_boss_5"),		
              (this_or_next|eq,":wielded","itm_sp_princeps_scutum_1"),		
              (this_or_next|eq,":wielded","itm_sp_princeps_scutum_2"),		
              (this_or_next|eq,":wielded","itm_sp_princeps_scutum_3"),		
              (this_or_next|eq,":wielded","itm_sp_princeps_scutum_4"),		
              (this_or_next|eq,":wielded","itm_sp_princeps_scutum_5"),		
              (this_or_next|eq,":wielded","itm_sp_triarii_scutum_1"),		
              (this_or_next|eq,":wielded","itm_sp_triarii_scutum_2"),		
              (this_or_next|eq,":wielded","itm_sp_triarii_scutum_3"),		
              (this_or_next|eq,":wielded","itm_sp_triarii_scutum_4"),						  
              (this_or_next|eq,":wielded","itm_sp_samnite_scutum_1"),
              (this_or_next|eq,":wielded","itm_sp_samnite_scutum_2"),
              (this_or_next|eq,":wielded","itm_sp_samnite_scutum_3"),
              (this_or_next|eq,":wielded","itm_sp_samnite_scutum_4"),
              (this_or_next|eq,":wielded","itm_sp_samnite_scutum_5"),
              (this_or_next|eq,":wielded","itm_sp_samnite_scutum_6"),
              (this_or_next|eq,":wielded","itm_sp_samnite_scutum_7"),		
              (this_or_next|eq,":wielded","itm_sp_s_etruscan_scutum_1"),
              (this_or_next|eq,":wielded","itm_sp_s_etruscan_scutum_2"),	
              (this_or_next|eq,":wielded","itm_sp_s_etruscan_scutum_3"),	
              (this_or_next|eq,":wielded","itm_sp_s_etruscan_scutum_4"),	
              (this_or_next|eq,":wielded","itm_sp_s_etruscan_scutum_5"),	
              (this_or_next|eq,":wielded","itm_sp_s_etruscan_scutum_6"),	
              (this_or_next|eq,":wielded","itm_sp_s_etruscan_scutum_7"),						  
			  (eq,":wielded","itm_sp_s_etruscan_scutum_8"),
			  
   (agent_get_slot, ":cover", ":agent_no", slot_agent_cover),
   (try_begin),
     (eq, ":cover", 0),
     (display_message,"@testudo on."),
     (assign, ":cover", 1),     
     (agent_set_speed_modifier, ":agent_no", 40), 		 
   ...
   (try_begin),	 
	...
	(call_script, "script_cf_troop_speed_system", ":agent_no"),	
	 ...
	 (else_try),	
     (agent_set_speed_modifier, ":agent_no", 100),		 
     (display_message,"@testudo off."),
     (assign, ":cover", 0),
	 (multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_cover_shield_end"),  
   (try_end),
...
raw_phalanx = (0, 0, 2, [(key_clicked, key_c)],
  [(get_player_agent_no, ":agent_no"),
   (agent_is_active, ":agent_no"),		  
   (agent_is_alive, ":agent_no"),	
   (agent_get_horse, ":horse", ":agent_no"),
   (le, ":horse", 0),
    ...
    (agent_get_wielded_item, ":wielded",":agent_no", 0), 
              (this_or_next|eq,":wielded","itm_w_macedonian_sarissa_bronze"),		
              (this_or_next|eq,":wielded","itm_w_macedonian_sarissa_steel"),		
              (this_or_next|eq,":wielded","itm_w_mak_sarissa"),					  
			  (eq,":wielded","itm_w_mak_sarissa_leather"),
			  
   (agent_get_slot, ":cover", ":agent_no", slot_agent_cover),
   (try_begin),
     (eq, ":cover", 0),
     (display_message,"@phalanx on."),
     (assign, ":cover", 1),     
     # (agent_set_speed_modifier, ":agent_no", 40), 		 
     (multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_phalanx"),                
   (else_try),
     (ge, ":cover", 1),
   (try_begin),	 
	(eq, "$g_multiplayer_extra_encumbrance", 1), 
	# (call_script, "script_cf_troop_speed_system", ":agent_no"),	
     (display_message,"@phalanx off."),	
     (assign, ":cover", 0),	
	 (multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_cover_shield_end"),  
	 (else_try),	
     # (agent_set_speed_modifier, ":agent_no", 100),		 
...
raw_charge = (0, 0, 2, [(key_clicked, key_b)],
  [(get_player_agent_no, ":agent_no"),
   (agent_is_active, ":agent_no"),		  
   (agent_is_alive, ":agent_no"),	
   (agent_get_horse, ":horse", ":agent_no"),
   ...
   (try_begin),
     (eq, ":cover", 0),
     (display_message,"@charge on."),
     (assign, ":cover", 1),      		 
     (multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_rider_charge"),   
	 (multiplayer_send_int_to_server,multiplayer_event_sound_at_player, "snd_man_yell"),	 
   (else_try),
     (ge, ":cover", 1),
   (try_begin),	 
	(eq, "$g_multiplayer_extra_encumbrance", 1), 
     (display_message,"@charge off."),	
     (assign, ":cover", 0),	
	 (multiplayer_send_int_to_server,multiplayer_event_animation_at_player, "anim_cover_shield_end"),  
	 (else_try),			 
     (display_message,"@charge off."),
...
raw_guarantee_legs = (ti_on_agent_spawn, 0, 0, [
   (this_or_next|multiplayer_is_dedicated_server),      
   (this_or_next|multiplayer_is_server),
   (neg|game_in_multiplayer_mode),   
],             
...
common_random_multiplayer_weather_server = (
  ...
  [
     ...
     (eq, "$g_multiplayer_fog", 1),	  
         (try_begin),
            (multiplayer_is_server),

            # (store_random_in_range, "$rain_strength", 50,150),
            (store_random_in_range, "$fog_dist", 90,500),
           ...
           (try_for_range, ":player_no", 1, ":num_players"), #0 is server so starting from 1
             ...
             # (multiplayer_send_int_to_player, ":player_no", multiplayer_event_return_weather, "$fog_dist"),
           (try_end),
         (try_end),
...
common_random_multiplayer_day_time_server = (
  ...
  [
         ...
         (try_begin),
            ...
            (store_random_in_range, "$day_time", 4,16),
...
scene_weather_trigger = (ti_before_mission_start, 0, 0, [],
[
		(store_current_scene,":current_scene"),
		
		(try_begin),
# Night, fog and rain maps		
			(this_or_next|eq,":current_scene","scn_geranigus_4"),		
			(eq,":current_scene","scn_swamp"),
            (set_rain, 1, 100),
            (set_fog_distance, 80, 0xbfbfbf), #fog distance between 20-250, color is grey			
			(assign,"$g_time_of_day", 1), # Night
        (else_try),
# Early morning maps		
			(this_or_next|eq,":current_scene","scn_multi_scene_1"),		
			(this_or_next|eq,":current_scene","scn_multi_scene_3"),	
			(this_or_next|eq,":current_scene","scn_multi_scene_4"),				
			(eq,":current_scene","scn_multi_scene_6"),		
			(assign,"$g_time_of_day", 11),		
        (else_try),
# Afternoon maps
			(this_or_next|eq,":current_scene","scn_multi_scene_2"),		
			(this_or_next|eq,":current_scene","scn_multi_scene_7"),				
			(eq,":current_scene","scn_multi_scene_9"),				
			(assign,"$g_time_of_day", 16),	
        (else_try),
# Night maps		
			(this_or_next|eq,":current_scene","scn_multi_scene_5"),					
			(eq,":current_scene","scn_multi_scene_10"),				
			(assign,"$g_time_of_day", 23),
            (set_rain, 1, 80),			
        (else_try),
# Night and rain maps						
			(eq,":current_scene","scn_multi_scene_8"),				
			(assign,"$g_time_of_day", 21),				
        (else_try),		
...
# Register 0: damage dealer item_id CC, Brytenwalda
		...
		[	(set_fixed_point_multiplier, 10),
			(try_for_agents,":cur_agent"),
				...
				(try_begin),#unmounted agent
					...
					(store_sub,":damage",":cur_agent_hp",25),
...
raw_phalanx_ai = (
  ...
  [
   ...
   (le, ":horse", 0),
    ...
    (agent_set_walk_forward_animation, ":agent_no", "anim_phalanx", 1),			  			  
  ])	
...
common_battle_init_banner = (
  ...
  [
    ...
    (call_script, "script_cf_troop_equipment_system", ":agent_no"),		
  ])
...
common_siege_defender_reinforcement_check = (
  ...
  [(lt, "$defender_reinforcement_stage", 7),
   ...
   (try_begin),
     (gt, ":mission_time", 180), #3 minutes, don't let small armies charge
     (get_player_agent_no, ":player_agent"),
     (agent_get_team, ":player_team", ":player_agent"),
...
common_battle_check_victory_condition = (
  ...
  [
    (store_mission_timer_a,reg(1)),
    (ge,reg(1),10),
    # (all_enemies_defeated, 5), # RaW Edit
	(call_script, "script_all_enemies_routed"), #RaW added
	(eq, reg0, 0), #RaW added
    ##diplomacy begin
    (this_or_next|eq, "$g_dplmc_battle_continuation", 0),
...
#-----------------------------------------------------------------
  ...
  (
   ...
   [
     ...
     (try_begin), 
       (this_or_next|eq, ":dead_agent_troop_no", "trp_sp_roman_triarius"),
       (this_or_next|eq, ":dead_agent_troop_no", "trp_sp_greek_hoplites"),
       (this_or_next|eq, ":dead_agent_troop_no", "trp_sp_celtic_argos"),
       (eq, ":dead_agent_troop_no", "trp_sp_makedonian_hypaspist"),
  ...
  (
    ...
    "village_training",
    [(2,mtef_visitor_source|mtef_team_0,af_override_everything,aif_start_alarmed,1,[]),
    ...
    [
      (ti_on_agent_spawn, 0, 0, 
       ...
       [
         ...
         (assign, ":initial_courage_score", 4000), # Was 5000
                  
         (agent_get_troop_id, ":troop_id", ":agent_no"),
         (store_character_level, ":troop_level", ":troop_id"),
         (val_mul, ":troop_level", 150), # Was 35
...
# RaW entry points for SP siege  
  (
    ...
    [
     ...
     (46,mtef_defenders|mtef_team_0|mtef_archers_first,af_override_horse,aif_start_alarmed,1,[]),
	 # New
     (47,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,1,[]),
     (48,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,1,[]),
     (49,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,1,[]),	 	 
     (50,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,1,[]),
     (51,mtef_defenders|mtef_team_0,af_override_horse,aif_start_alarmed,1,[]),
	 
     (52,mtef_attackers|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),
     (53,mtef_attackers|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),
     (54,mtef_attackers|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),
     (55,mtef_attackers|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),	 
     (56,mtef_attackers|mtef_team_1,af_override_horse,aif_start_alarmed,1,[]),	 
  ...
  (
    ...
    [    
      ...
      [
        ...
        (try_begin), 
          (this_or_next|eq, ":dead_agent_troop_no", "trp_sp_makedonian_hypaspist"),
          (this_or_next|eq, ":dead_agent_troop_no", "trp_sp_celtic_argos"),
          (this_or_next|eq, ":dead_agent_troop_no", "trp_sp_greek_hoplites"),
          (eq, ":dead_agent_troop_no", "trp_sp_roman_triarius"),
          # (this_or_next|eq, ":dead_agent_troop_no", "trp_rhodok_prison_guard"),
          # (eq, ":dead_agent_troop_no", "trp_sarranid_prison_guard"),
...
#         (tutorial_box, "str_trainer_help_2", "@Tutorial"),
  ...
  (
    ...
    [
      (16, mtef_visitor_source|mtef_team_0,af_override_everything,aif_start_alarmed,1,[]),
      (17, mtef_visitor_source|mtef_team_1,af_override_everything,aif_start_alarmed,1,[]),
      (18, mtef_visitor_source|mtef_team_2,af_override_everything,aif_start_alarmed,1,[]),
  ...
  (
    ...
    "Training.",
    [
      (0,mtef_visitor_source|mtef_team_0,af_override_everything,aif_start_alarmed,1,[]),
      (1,mtef_visitor_source|mtef_team_1,af_override_everything,aif_start_alarmed,1,[]),
      (2,mtef_visitor_source|mtef_team_1,af_override_everything,aif_start_alarmed,1,[]),
       ...
       [
        ...
        (try_for_range, ":guard_no", 0, ":num_guards"),
          ...
          (try_begin),
            ...
            (eq, ":guard_no", 2),
            (faction_get_slot, ":troop_of_guard", ":town_faction", slot_faction_guard_troop),
          (else_try),  
            (faction_get_slot, ":troop_of_guard", ":town_faction", slot_faction_guard_troop),
          (try_end),
...
#32
      (32, mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[]),
      (33,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[]),
      (34,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[]),
      (35,mtef_visitor_source|mtef_team_4,af_override_all,aif_start_alarmed,1,[]),
      (36, mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[]),
      (37,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[]),
      (38,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[]),
      (39,mtef_visitor_source|mtef_team_4,af_override_all,aif_start_alarmed,1,[]),
#40-49 not used yet
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[]),
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[]),
      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[]),
...
#used for torunament master scene
      ...
      (56, mtef_visitor_source|mtef_team_0, af_override_all, aif_start_alarmed, 1, [itm_a_chiton, itm_straw_hat]),
      (57, mtef_visitor_source|mtef_team_0, af_override_all, aif_start_alarmed, 1, [itm_a_chiton, itm_straw_hat]),
    ],
    tournament_triggers
  ),
  ...
  (
    ...
    [    
	  (0, mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[]),
	  (16, mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[]),
    ],
    [
      common_inventory_not_available,
      (ti_tab_pressed, 0, 0, [(display_message, "str_cannot_leave_now")], []),
...
##  ),
  ...
  (
    ...
    "Wedding",
    [
        (0,mtef_visitor_source,af_override_everything,0,1,[itm_a_chiton, itm_b_iphicratids]),
        ...
        (3,mtef_visitor_source,af_override_everything,0,1,[itm_a_chiton, itm_b_iphicratids]),
  ...
  (
    ...
    [
      ...
      (32,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      (33,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      (34,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      (35,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      ...
      (41,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      (42,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      ...
      (61,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      (62,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      (63,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      (64,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[]),
      ],
    [
      (ti_tab_pressed, 0, 0, [],
       [(try_begin),
      ...
      (ti_on_agent_spawn, 0, 0, [],
       [
         ...
         (try_begin),
           ...
           (agent_get_position, pos1, ":agent_no"),
           (agent_set_scripted_destination, ":agent_no", pos1),
           (scene_prop_get_num_instances, ":num_instances", "spr_archery_target_with_it_a"),
           (assign, ":shortest_dist", 10000000),
           (assign, ":best_instance", -1),
           (try_for_range, ":cur_instance", 0, ":num_instances"),
             (scene_prop_get_instance, ":spr_instance", "spr_archery_target_with_it_a", ":cur_instance"),
      ...
      (0, 0, 0,
       [
         ...
         (else_try),
           ...
           (else_try),
             (assign, ":prop_to_search_for", "spr_archery_target_with_it_a"),
...
##         (try_end),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only,af_override_everything,0,1,[itm_tutorial_shield,itm_tutorial_sword,itm_tutorial_short_bow,itm_tutorial_arrows,itm_a_exomis,itm_b_iphicratids]), #af_override_weapons
     ],
    [
      (ti_tab_pressed, 0, 0, [],
       [(try_begin),
...
##  ),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_tutorial_shield,itm_a_exomis,itm_b_iphicratids]),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_a_exomis,itm_b_iphicratids]),
        (3,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_tutorial_staff,itm_a_exomis,itm_b_iphicratids]), 
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_tutorial_sword,itm_tutorial_short_bow,itm_tutorial_arrows,itm_a_exomis,itm_b_iphicratids]), #af_override_weapons
     ],
    [
      (ti_tab_pressed, 0, 0, [],
       [(try_begin),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_visitor_source|mtef_team_0,af_override_everything,0,1,[itm_tutorial_sword,itm_tutorial_shield,itm_tutorial_short_bow,itm_tutorial_arrows,itm_tutorial_saddle_horse,itm_a_exomis,itm_b_iphicratids]),
        (1,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (2,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (3,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (4,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
  ...
  (
    ...
    [
      ...
      (ti_before_mission_start, 0, 0, [],
       [
      (store_random_in_range, ":rand", 0, 20), #multiplayer random weather
     (scene_set_day_time, ":rand"), #multiplayer random weather
         ]),
...
# RaW EnD		       
    ...
    [
      ...
      (1, 0, 0, [(multiplayer_is_server),
				...
				(try_end),], #death mod cannot start at last 15 seconds
       [
...
#plus 
  # (
    # "lead_charge_naval_battle",mtf_battle_mode,charge,#
    # "You lead your men to battle.",
    # [
     # (1,mtef_defenders|mtef_team_0|mtef_use_exact_number,af_override_horse,aif_start_alarmed,33,[]),
     # (0,mtef_defenders|mtef_team_0|mtef_use_exact_number,af_override_horse,aif_start_alarmed,0,[]),
     # (4,mtef_attackers|mtef_team_1|mtef_use_exact_number,af_override_horse,aif_start_alarmed,33,[]),
     # (4,mtef_attackers|mtef_team_1|mtef_use_exact_number,af_override_horse,aif_start_alarmed,0,[]),
     # ],
    # [
      ...
      # (ti_on_agent_spawn, 0, 0, [],
       # [
		...
		# (try_begin),
			...
			# (agent_get_party_id, ":agent_party_id", ":agent_no"),
			# (eq, ":agent_party_id", "p_main_party"),
			
			# (agent_get_ammo,":total_ammo",":agent_no", 0),
			# (agent_set_slot, ":agent_no", slot_agent_total_ammo, ":total_ammo"),
			
			# (agent_get_troop_id, ":agent_troop", ":agent_no"),
			# (troop_slot_eq, ":agent_troop", slot_troop_specified_weapons, 1),
			# (try_begin),
				# (neg|troop_is_hero, ":agent_troop"),
				# (try_for_range, ":weapon_slot", 0, 4),
					# (agent_get_item_slot, ":equ_weapon", ":agent_no",":weapon_slot"),
					# (gt, ":equ_weapon", 0),
					# (agent_unequip_item, ":agent_no", ":equ_weapon", ":weapon_slot"),
				# (try_end),
				# (assign, ":weapon_slot",0),
				# (try_for_range, ":set_weapon", slot_troop_weapon_1, slot_troop_weapon_primary),
					# (troop_get_slot, ":cur_weapon", ":agent_troop", ":set_weapon"),
					# (try_begin),
						# (gt, ":cur_weapon", 0),
						# (agent_equip_item, ":agent_no", ":cur_weapon", ":weapon_slot"),
					# (try_end),
					# (val_add, ":weapon_slot",1),
				# (try_end),
			# (try_end),
		# (try_end),
		
		# (try_begin),#Move reinforcement to ship
			# (this_or_next|gt,"$defender_reinforcement_stage",0),
			# (gt,"$attacker_reinforcement_stage",0),
			# (agent_get_team, ":team_no", ":agent_no"),
			# (try_begin),
				# (eq, ":team_no", 0),
				# (agent_set_position,":agent_no",pos61),
				# (position_move_x, pos61, 50),
			# (else_try),
				# (agent_set_position,":agent_no",pos62),
				# (position_move_x, pos62, 50),
			# (try_end),
		# (try_end),
         # ]),
      ...
      # (ti_before_mission_start, 0, 0, [],
       # [
		...
		# (assign, "$water_battle", 1),#
		# (assign, "$temp", 1),
		# (assign, "$temp_2", -1),
		# (assign, "$temp_3", 1),
		# (assign, reg11, 1),#entry_11 
		# (assign, reg12, 1),#entry_12 
		# (assign, reg13, 1),#entry_13 
		# (assign, reg14, 1),#entry_14 
		# (assign, reg49, -1),#hold/fire record
		# (assign, reg48, 1),#contact check
         # ]),

      
      # (0, 0, ti_once, [], [(assign,"$g_battle_won",0),
                           # (call_script, "script_place_player_banner_near_inventory"),
                           # (assign, "$g_defender_reinforcement_limit", "$field_reinforcement_number"),
						   # (set_fog_distance, 300, 0xcccccc),
                           # ]),
      ...
      # (lt,"$defender_reinforcement_stage","$g_defender_reinforcement_limit"),
                 ...
                 # (lt,":num_defenders",2)],
           # [
			# (scene_prop_get_instance, ":ship", "spr_ship_plus", 0),
			# (prop_instance_get_position, pos61, ":ship"),
			# (position_move_x, pos61, -800),
			# (position_move_y, pos61, -100),
			# (position_move_z, pos61, 120),
			# (val_add,"$defender_reinforcement_stage",1),(add_reinforcements_to_entry,0,15),(assign, "$defender_reinforcement_limit_increased", 0),
		   # ]),
      
      # (1, 0, 5, [(lt,"$attacker_reinforcement_stage",10),
                 # (store_mission_timer_a,":mission_time"),
                 # (ge,":mission_time",10),
                 # (store_normalized_team_count,":num_attackers", 1),
                 # (lt,":num_attackers",2)],
           # [
			# (scene_prop_get_instance, ":ship", "spr_ship_b_plus", 0),
			# (prop_instance_get_position, pos62, ":ship"),
			# (position_move_x, pos62, -800),
			# (position_move_y, pos62, -100),
			# (position_move_z, pos62, 120),
			# (val_add,"$attacker_reinforcement_stage",1),(add_reinforcements_to_entry,3,15),
		   # ]),


      # (1, 4, ti_once, [(main_hero_fallen)],
          # [
			  # (assign, "$water_battle", 0),#
              # (assign, "$pin_player_fallen", 1),
              # (str_store_string, s5, "str_retreat"),
              # (call_script, "script_simulate_retreat", 10, 20, 1),
              # (assign, "$g_battle_result", -1),
...
# (  1, 60, ti_once,
  # [
	...
	# (else_try),
		# (agent_set_animation, ":player_agent", "anim_cheer", 0),
	# (try_end),
	# (agent_get_troop_id, ":player_troop", ":player_agent"),
	# (troop_get_type, ":player_type", ":player_troop"),
	# (try_begin),
		# (eq, ":player_type", 0),
  ...
  # [
    ...
    # ]),
	  ...
	  # [
		...
		# (0, 8, 0, [#Select tactics
		# (eq, "$temp", 1),
		# (this_or_next|eq, reg11, 1),
		# (eq, reg13, 1),
		# ],
		# [
		# (neg|main_hero_fallen, 0),
		# (assign, "$temp", 2),
		# (party_get_skill_level, ":skill_lv", "p_main_party", skl_pathfinding),
		# (val_mul, ":skill_lv", 5),
		# (val_add, ":skill_lv", 50),
		# (store_sub, ":modf", 75, ":skill_lv"),
		# (store_sub, reg6, 50, ":modf"),
		# (val_clamp, reg6, 1, 100),
		# (question_box,"@Select the Tactics:^^^Select 'Yes' for a frontal attack that you will fight hand-to-hand while your ship connecting with the enemy's. ^^Select 'No' for an Outflanking attack that you will move around and fight circuitously. The higher pathfinding skill higher success rate. The current success rate: {reg6}%"),
		# ]),
		# (ti_question_answered, 0, 0, [],
		# [
		# (store_trigger_param_1,":answer"),
		...
		# (else_try),
			# (try_begin),
				# (eq,":answer",0),
				# (assign,"$temp_2",1),#=1 Fight Hand to hand
			# (else_try),
				# (assign,"$temp_2",2),#=2 Outflanking
			# (try_end),
		# (try_end),
		# ]),
		...
		# (gt,"$temp_2",0),
		# (scene_prop_get_instance, ":ship", "spr_ship_plus", 0),
		# (prop_instance_get_position, pos1, ":ship"),
		# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
		# (prop_instance_get_position, pos2, ":ship_b"),
		# (get_distance_between_positions,reg1,pos1,pos2),
		# (lt,reg1,2500),
		# ],
		# [
		# (try_begin),
			# (eq,"$temp_2",1),#=1 Fight Hand to hand
			# (display_message, "@Fight Hand-to-hand!"),
			# (assign, "$temp", 3),#Not retreat immediately
		# (else_try),
			# (eq,"$temp_2",2),#=2 Outflanking
			# (party_get_skill_level, ":skill_lv", "p_main_party", skl_pathfinding),
			# (val_mul, ":skill_lv", 5),
			# (val_add, ":skill_lv", 50),
			# (store_sub, ":modf", 75, ":skill_lv"),
			...
			# (try_begin),
				# (le, reg1, reg6),#Outflanking success
				# (scene_prop_get_instance, ":ship", "spr_ship_plus", 0),
				# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
				# (entry_point_get_position,pos1, 14),	  
				# (entry_point_get_position,pos2, 12),	  
				# (try_begin),
					# (eq, "$temp_3", 1),#first half a lap
					# (prop_instance_animate_to_position, ":ship", pos1, 5000),
					# (prop_instance_animate_to_position, ":ship_b", pos2, 5000),
					# (assign, "$temp_3", 2),#
				# (else_try),
					# (eq, "$temp_3", 2),#after half a lap
					# (prop_instance_animate_to_position, ":ship", pos2, 5000),
					# (prop_instance_animate_to_position, ":ship_b", pos1, 5000),
					# (assign, "$temp_3", 1),#
				# (try_end),
				# (display_message, "@Outflanking Tactics Success!"),
			# (else_try),
				# (display_message, "@Outflanking Tactics Failure!"),
				# (display_message, "@Fight Hand-to-hand!"),
				# (assign, "$temp", 3),#Not retreat immediately
			# (try_end),
		# (try_end),
		...
		# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
		# (prop_instance_get_position, pos2, ":ship_b"),
		# (entry_point_get_position,pos3, 12),
		# (get_distance_between_positions,reg1,pos1,pos3),
		# (get_distance_between_positions,reg2,pos2,pos3),
		# (this_or_next|le,reg1,100),
		# (le,reg2,100),
		# (entry_point_get_position,pos4, 13),
		# (try_begin),
			# (le,reg1,100),
			# (prop_instance_animate_to_position, ":ship", pos4, 3000),
		# (else_try),
			# (le,reg2,100),
			# (prop_instance_animate_to_position, ":ship_b", pos4, 3000),
		# (try_end),
		# (assign, reg12, -1),
		# ],[(assign, reg12, 1),]),
		...
		# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
		# (prop_instance_get_position, pos2, ":ship_b"),
		# (entry_point_get_position,pos3, 14),
		# (get_distance_between_positions,reg1,pos1,pos3),
		# (get_distance_between_positions,reg2,pos2,pos3),
		# (this_or_next|le,reg1,100),
		# (le,reg2,100),
		...
		# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
		# (prop_instance_get_position, pos2, ":ship_b"),
		# (entry_point_get_position,pos3, 13),
		# (get_distance_between_positions,reg1,pos1,pos3),
		# (get_distance_between_positions,reg2,pos2,pos3),
		# (this_or_next|le,reg1,100),
		# (le,reg2,100),
		# (entry_point_get_position,pos4, 20),
		# (try_begin),
			# (le,reg1,100),
			# (prop_instance_animate_to_position, ":ship", pos4, 4500),
		# (else_try),
			# (le,reg2,100),
			# (prop_instance_animate_to_position, ":ship_b", pos4, 4500),
		# (try_end),
		# (assign, reg13, -1),
		# (assign, "$temp", 1),
		# (assign, reg48, 2),#
		...
		# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
		# (prop_instance_get_position, pos2, ":ship_b"),
		# (entry_point_get_position,pos3, 11),
		# (get_distance_between_positions,reg1,pos1,pos3),
		# (get_distance_between_positions,reg2,pos2,pos3),
		# (this_or_next|le,reg1,100),
		# (le,reg2,100),
		# (entry_point_get_position,pos4, 21),
		# (try_begin),
			# (le,reg1,100),
			# (prop_instance_animate_to_position, ":ship", pos4, 4500),
		# (else_try),
      ...
      # (1, 2, 3, [#
		# (get_player_agent_no, ":player_agent"),
		# (agent_get_team, ":i_team", ":player_agent"),
		# (assign, ":ctn", 0),
		# (try_begin),
			# (eq, reg49, -1),
			# (try_for_range, ":class_no", 0, 8),
				# (team_get_hold_fire_order, ":cur_hold_fire", ":i_team", ":class_no"),
      ...
      # (0, 0.5, ti_once, [#start move
		# (play_sound, "snd_sea"),
		# (scene_prop_get_instance, ":ship", "spr_ship_plus", 0),
		# (ge, ":ship", 0),
		# (entry_point_get_position,pos1, 10),	  
		# (prop_instance_set_position, ":ship", pos1, 0),

		# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
		# (ge, ":ship_b", 0),
		# (entry_point_get_position,pos1, 9),	  
		# (prop_instance_set_position, ":ship_b", pos1, 0),
		# ],[
		# (scene_prop_get_instance, ":ship", "spr_ship_plus", 0),
		# (entry_point_get_position,pos1, 20),	  
		# (prop_instance_animate_to_position, ":ship", pos1, 5500),
		
		# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
		# (entry_point_get_position,pos1, 21),	  
		# (prop_instance_animate_to_position, ":ship_b", pos1, 5500),
		# ]),
	  
      # (0.2, 1, ti_once, [#
		# (scene_prop_get_instance, ":ship", "spr_ship_b_plus", 0),
		# (ge, ":ship", 0),
		# (prop_instance_get_position, pos20, ":ship"),
		# (try_begin),
			# (eq, "$temp_3", 1),#first half a lap
			# (assign, ":cur_entry", 21),
		# (else_try),
			...
			# (assign, ":cur_entry", 20),
		# (try_end),
		# (entry_point_get_position,pos21, ":cur_entry"),
		# (get_distance_between_positions,reg1,pos20,pos21),
		# (lt,reg1,20),
		# (try_for_agents, ":agent_no"),
			# (agent_is_alive, ":agent_no"),
			# (agent_clear_scripted_mode, ":agent_no"),
		...
		# (assign, reg48, -1),#
		# ],[
		# (scene_prop_get_instance, ":ramp", "spr_arabian_ramp_a", 0),
		# (try_begin),
			# (eq, "$temp_3", 1),#first half a lap
			# (assign, ":cur_entry", 23),
			# (assign, ":z_move", 0),
		...
		# (try_end),
		# (entry_point_get_position,pos21, ":cur_entry"),
		# (position_move_z, pos21, ":z_move"),
		# (prop_instance_set_position, ":ramp", pos21, 0),
				# ]),
      # (0.2, 1, ti_once, [#
		# (scene_prop_get_instance, ":ship", "spr_ship_plus", 0),
		# (ge, ":ship", 0),
		...
		# (assign, reg48, -1),#
		# ],[
		# (scene_prop_get_instance, ":ramp", "spr_arabian_ramp_b", 0),
		# (try_begin),
			# (eq, "$temp_3", 1),#first half a lap
			# (assign, ":cur_entry", 22),
		# (else_try),
     ...
     # (0.1, 0, 0, [(neq,"$temp",3),
	  # ],
		...
		# (try_begin),
			# (eq, ":i_team", 0),
			# (assign, ":i_ship", ":ship"),
			# (assign, ":e_ship", ":ship_b"),
		# (else_try),
			# (assign, ":i_ship", ":ship_b"),
			# (assign, ":e_ship", ":ship"),
		# (try_end),
		# (prop_instance_get_position, pos40, ":i_ship"),
		# (prop_instance_get_position, pos41, ":e_ship"),
		# (position_move_z, pos40, 120),
		# (position_move_z, pos41, 120),
		# (entry_point_get_position,pos1, 0),
		# (position_move_z, pos1, 30),
		# (position_get_z,":oz",pos1),
		
		# (get_player_agent_no,":player_no"),
		# (try_for_agents,":agent_no"),
			# (neq, ":agent_no",":player_no"),
			# (agent_is_alive, ":agent_no"),
			# (agent_get_position,pos1,":agent_no"),
			...
			# (try_begin),
				# (agent_is_ally, ":agent_no"),
				# (position_transform_position_to_local, pos2,pos40,pos1),
				# (position_get_y,":y",pos2),
				# (try_begin),
					# (position_is_behind_position, pos1, pos40),
					# (val_add, ":y", 400),
				# (else_try),
					# (val_sub, ":y", 400),
				# (try_end),
				# (position_set_y, pos2, ":y"),
				# (position_transform_position_to_parent,pos3,pos40,pos2),
			# (else_try),
				# (position_transform_position_to_local, pos2,pos41,pos1),
				# (position_get_y,":y",pos2),
				# (try_begin),
					# (position_is_behind_position, pos1, pos41),
					# (val_add, ":y", 400),
				# (else_try),
					# (val_sub, ":y", 400),
				# (try_end),
				# (position_set_y, pos2, ":y"),
				# (position_transform_position_to_parent,pos3,pos41,pos2),
			# (try_end),
			# (position_set_z, pos3, ":oz"),
     ...
     # (2, 0, 0, [#(eq,1,0),
	  # ],
          # [
		# (entry_point_get_position,pos1, 21),
		# (position_get_z,":entry_z",pos1),
		# (try_for_agents,":agent_no"),
			# (agent_is_alive, ":agent_no"),
			# (agent_get_slot, ":dead_time", ":agent_no", slot_agent_is_dead_for_waterbattle),
			# (eq, ":dead_time", 0),
			# (agent_get_position,pos1,":agent_no"),
			# (position_get_z,":z",pos1),
			# (lt,":z",":entry_z"),
			# (agent_set_slot, ":agent_no", slot_agent_is_dead_for_waterbattle, -1),
			# (agent_set_hit_points,":agent_no",0,0),
			# (set_show_messages, 0),
			# (agent_deliver_damage_to_agent,":agent_no",":agent_no",0),
			# (set_show_messages, 1),
			# (agent_get_troop_id, ":troop", ":agent_no"),
			# (str_store_troop_name, s1, ":troop"),
			# (display_message, "@{s1} withdrawal from battle for drowning!",0xcc0000),
		# (try_end),
		  # ]),
		  
		  
 	  #Leaving the ship will be killed. Unnecessary
     # (3, 0, 0, [(eq,1,0),
		# (this_or_next|eq, reg48, 2),#
		# (eq, reg48, 1),#
		# (scene_prop_get_instance, ":ship", "spr_ship_plus", 0),
		# (prop_instance_get_position, pos2, ":ship"),
		# (copy_position,pos4, pos2),
		# (position_move_x, pos2, -600),
		# (copy_position,pos5, pos2),
		# (position_move_x, pos2, -600),
		# (copy_position,pos13, pos2),
		# (position_move_x, pos2, 1800),
		# (copy_position,pos6, pos2),
		# (position_move_x, pos2, 600),
		# (copy_position,pos14, pos2),
		# (scene_prop_get_instance, ":ship_b", "spr_ship_b_plus", 0),
		# (prop_instance_get_position, pos2, ":ship_b"),
		...
		# (try_for_agents,":agent_no"),
			...
			# (get_distance_between_positions,reg1,pos3,pos4),
			# (get_distance_between_positions,reg2,pos3,pos5),
			# (get_distance_between_positions,reg3,pos3,pos6),
			# (get_distance_between_positions,reg23,pos3,pos13),
			# (get_distance_between_positions,reg24,pos3,pos14),
			# (get_distance_between_positions,reg4,pos3,pos7),
			# (get_distance_between_positions,reg5,pos3,pos8),
			# (get_distance_between_positions,reg6,pos3,pos9),
			# (get_distance_between_positions,reg7,pos3,pos10),
			# (get_distance_between_positions,reg8,pos3,pos11),
			# (get_distance_between_positions,reg9,pos3,pos12),
			# (gt,reg1,800),
			# (gt,reg2,800),
			# (gt,reg3,800),
			# (gt,reg23,800),
...
# Move the body to the seabed
      # (ti_on_agent_killed_or_wounded, 0, 1, [
		# (neq, reg48, -1),
        # (store_trigger_param_1, ":dead_agent_no"),
		# (agent_slot_eq,":dead_agent_no",slot_agent_is_dead_for_waterbattle,0),
		# (get_player_agent_no, ":player_agent"),
		# (neq, ":player_agent", ":dead_agent_no"),
        # (store_mission_timer_a_msec, ":cur_time"),
		# (agent_set_slot, ":dead_agent_no", slot_agent_is_dead_for_waterbattle, ":cur_time"),
	  # ],[]),
      # (0.2, 0, 0, [(neq, reg48, -1)],
       # [
		# (entry_point_get_position,pos6, 30),
		# (try_for_agents,":agent_no"),
			# (agent_get_slot, ":dead_time", ":agent_no", slot_agent_is_dead_for_waterbattle),
			# (gt, ":dead_time", 0),
			# (store_mission_timer_a_msec, ":cur_time"),
			# (val_sub, ":cur_time", ":dead_time"),
			# (ge, ":cur_time", 800),
			# (agent_set_position, ":agent_no", pos6),
			# (agent_set_slot, ":agent_no", slot_agent_is_dead_for_waterbattle, -1),
		# (try_end),
       # ]),
	  
	  #Item boxes follow the boat
       # (0, 0, 0, [
		# (neq, reg48, -1),#
	  # ],
          # [
		...
		# (else_try),
			# (assign, ":i_ship", ":ship_b"),
		# (try_end),
		# (prop_instance_get_position, pos2, ":i_ship"),
		# (position_move_z, pos2, 110),
		# (scene_prop_get_instance, ":invt", "spr_inventory", 0),
		# (ge, ":invt", 0),
		# (prop_instance_set_position, ":invt", pos2, 0),
		  # ]),
	  ...
	  # ],
		...
		# (else_try),
			...
			# (assign, ":e_ship", ":ship"),
		# (try_end),
		# (prop_instance_get_position, pos5, ":i_ship"),
		# (position_move_y, pos5, 220),
		# (position_move_x, pos5, 1100),
		# (position_move_z, pos5, 120),
		# (prop_instance_get_position, pos6, ":e_ship"),
		# (position_move_y, pos6, 220),
		# (position_move_x, pos6, 1100),
		# (position_move_z, pos6, 120),
		# (assign, ":i_turn", 0),
		# (assign, ":e_turn", 0),
		# (try_for_agents, ":agent_no"),
			# (agent_is_alive, ":agent_no"),
			# (agent_get_ammo, reg1, ":agent_no", 0),
			# (ge, reg1, 1),
			# (try_begin),
				# (agent_is_ally, ":agent_no"),
				# (agent_set_scripted_destination,":agent_no",pos5,1),
				# (position_move_x, pos5, -110),
				# (val_add, ":i_turn", 1),
				# (try_begin),
					# (eq, ":i_turn", 20),
					# (position_move_x, pos5, 2000),
					# (position_move_y, pos5, -350),
				# (else_try),
					# (eq, ":i_turn", 40),
					# (position_move_x, pos5, 2000),
				...
				# (try_end),
			# (else_try),
				# (agent_set_scripted_destination,":agent_no",pos6,1),
				# (position_move_x, pos6, -110),
				# (val_add, ":e_turn", 1),
				# (try_begin),
					# (eq, ":e_turn", 20),
					# (position_move_x, pos6, 2000),
					# (position_move_y, pos6, -350),
				# (else_try),
					# (eq, ":e_turn", 40),
					# (position_move_x, pos6, 2000),
	...
	# (0.2, 0, 0,[#after contact or one team wins
		# (this_or_next|eq, reg48, 2),
		# (this_or_next|eq, reg48, -1),
		# (num_active_teams_le,1),
		# ],[
		# (try_for_agents, ":agent_no"),
			# (agent_is_alive, ":agent_no"),

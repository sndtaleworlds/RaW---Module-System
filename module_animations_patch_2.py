...
##   [0.8, "jump_loop", 0, 30, arf_blend_in_2|arf_cyclic],
   [2.9, "base_jump", 0, 124, arf_blend_in_18],
 ],
...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 # ],
  ...
  ["stand_single", 0, amf_client_prediction,
   [8.0, "pike_loop04", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0],
...
##   [1.09, "jump", 22, 48, arf_blend_in_1],
   [0.7, "rg_kick_rightleg", 12, 33, arf_blend_in_1],
 ],
...
#   [0.8, "anim_human", 7000, 7040, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)], 
   [0.8, "rg_run_man_forward", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
 ...
 [0.8, "rg_run_man_forward_onehanded", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
...
##   [0.8, "run_man_right", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "rg_run_forward_right", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
##   [0.8, "run_man_left", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "rg_run_forward_left", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
##   [0.8, "run_crossleft_greatsword", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ...
 ["run_backward", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [0.7, "rg_run_backward", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
##   [1.0, "run_man_forward", 24, 0, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
   [0.7, "rg_run_backward_right", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
#   [1.0, "anim_human", 7040, 7000, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
##   [1.0, "run_man_forward", 24, 0, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
   [0.7, "rg_run_backward_left", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
##   [22.0, "stand_onhorse_sword", 0, 671, arf_cyclic],
 ...
 ["ride_1", acf_enforce_lowerbody | acf_synch_with_orse, amf_client_prediction,
   [1.0, "anim_human_02", 0, 31, arf_cyclic],
 ],
 ["lancer_ride_1", acf_enforce_lowerbody | acf_synch_with_orse, amf_client_prediction|amf_priority_ride|amf_play,
##   [0.8, "anim_human", horse_move+210, horse_move+250, arf_cyclic |  arf_blend_in_16],
 ...
 ["ride_2", acf_enforce_lowerbody | acf_synch_with_orse, amf_client_prediction,
   [0.8, "anim_human_02", 50, 69, arf_cyclic], 
 ],
 ["ride_3", acf_enforce_lowerbody | acf_synch_with_orse, amf_client_prediction,
   [0.6, "anim_human_02", 100, 116, arf_cyclic], 
 ],
  ["ride_4", acf_enforce_lowerbody, amf_client_prediction,
   [0.5, "anim_human_02", 150, 165, arf_cyclic|arf_blend_in_32], 
   # ["ride_4",  acf_enforce_lowerbody |  acf_rot_vertical_sword, amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play,
    # [2.0, "rider_charge", 0, 99, arf_cyclic|arf_blend_in_128],  
 ],
# ["lancer_ride_4",  acf_enforce_lowerbody | acf_synch_with_orse | acf_rot_vertical_sword|acf_anim_length(100), 0,
#   [0.5, "anim_human", horse_move+610, horse_move+650, arf_cyclic | arf_blend_in_128], 
# ],
 ["lancer_ride_4",  acf_enforce_lowerbody | acf_synch_with_orse | acf_rot_vertical_sword|acf_anim_length(30), amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play,
   [0.5, "lancer_ride4", 0, 15, arf_cyclic | arf_blend_in_128], 
 ],
 ["lancer_ride_4_no_shield",  acf_enforce_lowerbody | acf_synch_with_orse | acf_rot_vertical_sword|acf_anim_length(30), amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play,
...
## [0.3, "anim_human_02", 420, 424,  arf_blend_in_16],
 ...
 ["ride_turn_right", acf_enforce_lowerbody | acf_synch_with_orse, amf_client_prediction,
   [1.0, "anim_human_02", 500, 533, arf_cyclic],
 ],
 ["ride_turn_left", acf_enforce_lowerbody | acf_synch_with_orse, amf_client_prediction,
...
##   [4.0, "anim_human", horse_move + 5000, horse_move + 5057, arf_lancer|arf_cyclic],
 ...
 ["equip_default", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   [0.6, "equip_javelin", 0, 15, arf_blend_in_0],
 ],
...
# RaW 
["ready_crossbow", acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.1, "throwing_slinge_20_35", 0, 15, blend_in_ready|arf_cyclic|arf_make_custom_sound, pack2f(0.14, 0.44)],
  ],
["release_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.9, "throwing_slinge", 34, 60, arf_blend_in_0|arf_make_custom_sound, pack2f(0.14, 0.44)],
],
["reload_crossbow", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [0.3, "throwing_slinge", 80, 115, arf_blend_in_8|arf_make_custom_sound, pack2f(0.10, 0.40)], 
],
# RaW 
 ...
 ["ready_javelin", acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.6, "rg_throw_javelin3", 0, 30, blend_in_ready],
 ],
 ["release_javelin", acf_rot_vertical_bow, amf_priority_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.9, "rg_throw_javelin3", 55, 100, arf_blend_in_0],
 ],
...
##   [0.61, "anim_human", combat+8510, combat+8540, blend_in_release], 
 ...
 ["blocked_thrust_onehanded", acf_enforce_rightside, amf_priority_blocked|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust,
   [attack_blocked_duration_thrust, "rg_parry_single_lefttoright", 0, 75, blend_in_parry], 
 ],
 ["parried_thrust_onehanded", acf_enforce_rightside, amf_priority_parried|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust,
   [attack_parried_duration_thrust, "rg_parry_single_lefttoright", 0, 75, blend_in_parry], 
 ],
...
##   [ready_durn, "attacks_thrust_onehanded", 0, 16, blend_in_ready], 
   [ready_durn, "rg_attacks_thrust_onehanded", 5, 13, blend_in_ready], 
 ],
...
##   [0.9, "attacks_thrust_onehanded", 16, 54, blend_in_release], 
   [0.62, "rg_attacks_thrust_onehanded", 12, 32, blend_in_release], 
 ],
...
##   [0.1, "attacks_thrust_onehanded", 54, 54, blend_in_continue], 
   [0.3, "rg_attacks_thrust_onehanded", 32, 54, blend_in_continue], 
 ],
...
##   [ready_durn, "anim_human", combat+8500, combat+8510, blend_in_ready],
  # [ready_durn, "spear_1h_thrust", 0, 5, blend_in_ready],
#  [ready_durn, "rg_staff_back_thrust", 0, 5, blend_in_ready],
   [ready_durn, "rg_lancer_2h_attack", 0, 5, blend_in_ready],
  ],
...
##   [0.61, "anim_human", combat+8510, combat+8540, blend_in_release], 
 #  [0.62, "spear_1h_thrust", 5, 34, blend_in_release],
 # [0.62, "rg_staff_back_thrust", 5, 34, blend_in_release],
   [0.8, "rg_lancer_2h_attack", 5, 32, blend_in_release],
 ],
...
#[0.3, "rg_staff_back_thrust", 34, 39, blend_in_continue],
   [0.4, "rg_lancer_2h_attack", 32, 40, blend_in_release],
 ],
# RaW 
...
##   [ready_durn, "attacks_single_righttoleft", 5, 10, blend_in_ready], 
   ...
   [ready_durn, "rg_attacks_single_righttoleft", 2, 5, blend_in_ready], 
   # [ready_durn, "rg2_attacks_single_righttoleft", 2, 5, blend_in_ready], 
 ],
...
##   [0.6, "attacks_single_righttoleft", 10, 26, blend_in_release], 
   ...
   [0.6, "rg_attacks_single_righttoleft", 5, 28, blend_in_release], 
   # [0.6, "rg2_attacks_single_righttoleft", 5, 28, blend_in_release], 
 ],
...
##   [0.4, "attacks_single_righttoleft", 26, 43, blend_in_continue], 
   ...
   [0.4, "rg_attacks_single_righttoleft", 28, 44, blend_in_continue], 
   # [0.4, "rg2_attacks_single_righttoleft", 28, 44, blend_in_continue], 
 ],
...
##   [attack_parried_duration, "anim_human", combat+8820, combat+8815, blend_in_parry], 
   [attack_blocked_duration, "rg_parry_single_righttoleft", 0, 14, blend_in_parry], 
 ],
 ["parried_slashright_onehanded", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
##   [attack_parried_duration, "anim_human", combat+8820, combat+8815, blend_in_parry], 
   [attack_parried_duration, "rg_parry_single_righttoleft", 0, 14, blend_in_parry], 
 ],
...
##   [ready_durn, "attacks_single_lefttoright", 12, 21, blend_in_ready], 
   # [ready_durn, "rg5_attacks_single_lefttoright", 4, 11, blend_in_ready], 
   [ready_durn, "rg2_attacks_single_lefttoright", 4, 11, blend_in_ready], 
   # [ready_durn, "rg3_attacks_single_lefttoright", 4, 11, blend_in_ready], 
   # [ready_durn, "rg4_attacks_single_lefttoright", 4, 11, blend_in_ready],    
 ],
...
##   [0.61, "attacks_single_lefttoright", 21, 40, blend_in_release], 
   # [0.61, "rg5_attacks_single_lefttoright", 11, 29, blend_in_release], 
   [0.61, "rg2_attacks_single_lefttoright", 11, 29, blend_in_release], 
   # [0.61, "rg3_attacks_single_lefttoright", 11, 29, blend_in_release], 
   # [0.61, "rg4_attacks_single_lefttoright", 11, 29, blend_in_release], 
 ],
...
##   [0.4, "attacks_single_lefttoright", 40, 50, blend_in_continue],
   # [0.4, "rg5_attacks_single_lefttoright", 29, 43, blend_in_continue],
   [0.4, "rg2_attacks_single_lefttoright", 29, 43, blend_in_continue],
   # [0.4, "rg3_attacks_single_lefttoright", 29, 43, blend_in_continue],
   # [0.4, "rg4_attacks_single_lefttoright", 29, 43, blend_in_continue],
 ],
...
##   [attack_blocked_duration, "anim_human", combat+9120, combat+9115, blend_in_parry], 
   [attack_blocked_duration, "rg_parry_single_lefttoright", 0, 75, blend_in_parry], 
 ],
...
##   [attack_parried_duration, "anim_human", combat+9120, combat+9115, blend_in_parry], 
   [attack_parried_duration, "rg_parry_single_lefttoright", 0, 75, blend_in_parry], 
 ],
...
##   [ready_durn, "attacks_single_overswing", 2, 16, blend_in_ready], 
   [ready_durn, "rg_attacks_single_overswing", 5, 16, blend_in_ready], 
 ],
...
##   [0.6, "attacks_single_overswing", 16, 35, blend_in_release], 
   [0.6, "rg_attacks_single_overswing", 16, 37, blend_in_release], 
 ],
 ["release_overswing_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_overswing|amf_client_owner_prediction,
   [0.2, "rg_attacks_single_overswing", 37, 40, blend_in_continue],
 ],
 ...
 ["ready_slash_orseback_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_right,
...
##   [ready_durn, "attacks_single_righttoleft_horseback", 8, 16, blend_in_ready], 
 ...
 ["release_slash_orseback_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right|amf_continue_to_next,
...
##   [0.6, "attacks_single_righttoleft_horseback", 16, 38, blend_in_release], 
 ...
 ["release_slash_orseback_right_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right|amf_client_owner_prediction,
   [0.4, "attacks_single_righttoleft_horseback", 39, 54, blend_in_continue],
  ],
 ["blocked_slash_orseback_right",acf_rot_vertical_sword|acf_anim_length(100), amf_priority_blocked|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right,
#   [attack_blocked_duration, "anim_human", combat+10120, combat+10115, blend_in_parry], 
   [attack_blocked_duration, "rg_parry_single_righttoleft", 0, 14, blend_in_parry], 
 ],
 ["parried_slash_orseback_right",acf_rot_vertical_sword|acf_anim_length(100), amf_priority_parried|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right,
#   [attack_parried_duration, "anim_human", combat+10120, combat+10115, blend_in_parry], 
   [attack_parried_duration, "rg_parry_single_righttoleft", 0, 14, blend_in_parry], 
 ],
 ["ready_slash_orseback_left", acf_left_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_left,
...
#   [ready_durn, "anim_human", combat+9100, combat+9110, blend_in_ready], 
 ...
 ["release_slash_orseback_left", acf_left_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left|amf_continue_to_next,
#   [0.6, "anim_human", combat+10410, combat+10440, blend_in_release], 
#   [0.6, "anim_human", combat+9110, combat+9140, blend_in_release], 
   [0.7, "attacks_single_lefttoright_horseback", 21, 43, blend_in_release], 
 ],
 ["release_slash_orseback_left_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left|amf_client_owner_prediction,
   [0.3, "attacks_single_lefttoright_horseback", 43, 51, blend_in_continue],
 ],
 ["blocked_slash_orseback_left",acf_rot_vertical_sword|acf_anim_length(100), amf_priority_blocked|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left,
#   [attack_blocked_duration, "anim_human", combat+10420, combat+10415, blend_in_parry], 
   [attack_blocked_duration, "rg_parry_single_lefttoright", 0, 75, blend_in_parry], 
 ],
 ["parried_slash_orseback_left",acf_rot_vertical_sword|acf_anim_length(100), amf_priority_parried|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left,
#   [attack_parried_duration, "anim_human", combat+10420, combat+10415, blend_in_parry], 
   [attack_parried_duration, "rg_parry_single_lefttoright", 0, 75, blend_in_parry], 
 ],

["ready_slash_orseback_polearm_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_right,
   [ready_durn, "attacks_staff_righttoleft", 6, 16, blend_in_ready], 
 ],
 ["release_slash_orseback_polearm_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right|amf_continue_to_next,
   [0.7, "attacks_staff_righttoleft", 16, 40, blend_in_release], 
  ],
 ["release_slash_orseback_polearm_right_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right|amf_client_owner_prediction,
   [0.4, "attacks_staff_righttoleft", 40, 48, blend_in_continue],
  ],
 ["blocked_slash_orseback_polearm_right",acf_rot_vertical_sword|acf_anim_length(100), amf_priority_blocked|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right,
   [attack_blocked_duration, "anim_human", combat+7915, combat+7913, arf_blend_in_2], 
 ],
 ["parried_slash_orseback_polearm_right",acf_rot_vertical_sword|acf_anim_length(100), amf_priority_parried|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right,
   [attack_blocked_duration, "anim_human", combat+7915, combat+7913, arf_blend_in_2], 
 ],
 ["ready_slash_orseback_polearm_left", acf_left_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_left,
   [ready_durn, "attacks_staff_lefttoright", 10, 16, blend_in_ready], 
 ],
 ["release_slash_orseback_polearm_left", acf_left_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left|amf_continue_to_next,
   [0.7, "attacks_staff_lefttoright", 16, 41, blend_in_release], 
 ],
 ["release_slash_orseback_polearm_left_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left|amf_client_owner_prediction,
   [0.3, "attacks_staff_lefttoright", 41, 55, blend_in_continue],
 ],
 ["blocked_slash_orseback_polearm_left",acf_rot_vertical_sword|acf_anim_length(100), amf_priority_blocked|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left,
   [attack_blocked_duration, "anim_human", combat+7615, combat+7613, arf_blend_in_2], 
 ],
 ["parried_slash_orseback_polearm_left",acf_rot_vertical_sword|acf_anim_length(100), amf_priority_parried|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left,
   [attack_blocked_duration, "anim_human", combat+7615, combat+7613, arf_blend_in_2], 
 ],
...
["defend_shield_forward", 0, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_use_inertia|amf_rider_rot_shield|amf_client_owner_prediction,
   [defend_duration, "rg_defend_shield_forward", 6, 25, blend_in_defense], 
  ],
["defend_shield_up", 0, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_use_inertia|amf_rider_rot_shield|amf_client_owner_prediction,
   [defend_duration, "rg_defend_shield_up", 1, 27, blend_in_defense], 
  ],
["defend_shield_right", 0, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_use_inertia|amf_rider_rot_shield|amf_client_owner_prediction,
   [defend_duration, "rg_defend_shield_right", 5, 26, blend_in_defense], 
  ],
["defend_shield_left", 0, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_use_inertia|amf_rider_rot_shield|amf_client_owner_prediction,
   [defend_duration, "rg_defend_shield_left", 5, 26, blend_in_defense], 
  ],
...
#   [defend_duration, "defend_shield_parry_all", 5, 26, blend_in_defense], 
   # [defend_duration, "rg_defend_shield_up", 1, 17, blend_in_defense], 
  ],
 ["defend_shield_keep", acf_parallels_for_look_slope|acf_anim_length(100), amf_rider_rot_shield|amf_priority_defend|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   ...
   # [defend_keep_duration, "rg2_anim_human_35010_35300", defend+118, defend+120, arf_blend_in_4|arf_cyclic],    
   # [defend_keep_duration, "rg2_anim_human_35010_35300", 17, 19, arf_blend_in_4|arf_cyclic],    
 ],
 ["defend_shield_parry_1", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   # [defend_parry_duration_1, "rg_defend_shield_parry_all", 1, 9, arf_blend_in_1], 
 ...
 ["defend_shield_parry_2", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   # [defend_parry_duration_2, "rg_defend_shield_parry_all", 1, 9, arf_blend_in_1], 
 ...
 ["defend_shield_parry_3", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   # [defend_parry_duration_3, "rg_defend_shield_parry_all", 1, 9, arf_blend_in_1], 
...
##   [defend_duration, "defend_onehanded", 8, 15, blend_in_defense], 
   [defend_duration, "rg_defend_forward_onehanded", 20, 41, blend_in_defense], 
...
##   [defend_duration, "anim_human", defend+1110, defend+1120, blend_in_defense], 
   [defend_duration, "rg_defend_up_onehanded", 9, 25, blend_in_defense], 
...
##   [defend_keep_duration, "anim_human", defend+1120, defend+1120, arf_blend_in_3|arf_cyclic], 
   [2.8, "rg_defend_up_onehanded_keep", 1, 87, arf_blend_in_3|arf_cyclic], 
 ],
...
##   [defend_duration, "anim_human", defend+1210, defend+1220, blend_in_defense], 
   [defend_duration, "rg_defend_right_onehanded", 14, 31, blend_in_defense], 
...
##   [defend_keep_duration, "anim_human", defend+1220, defend+1220, arf_blend_in_5|arf_cyclic], 
   [2.5, "rg_defend_right_onehanded_keep", 0, 79, arf_blend_in_5|arf_cyclic], 
 ],
...
##   [defend_duration, "anim_human", defend+1310, defend+1320, blend_in_defense], 
   [defend_duration, "rg_defend_left_onehanded", 12, 28, blend_in_defense], 
...
##   [defend_keep_duration, "anim_human", defend+1320, defend+1320, arf_blend_in_3|arf_cyclic], 
   [2.2, "rg_defend_left_onehanded_keep", 1, 71, arf_blend_in_3|arf_cyclic], 
 ],
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3], 
 ...
 ["fall_abdomen_hold_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [2.6, "death_abdomen", 5, 96, arf_blend_in_16|arf_make_custom_sound, pack2f(0.4, 0.0), (0,0,0), 2.35],
   [3.4, "new_death_7", 0, 194, arf_blend_in_16|arf_make_custom_sound, pack2f(0.4, 0.0), (0,0,0), 2.35],
 ],
 ...
 ["fall_body_back", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [3.6, "new_death_crawl", 0, 109, arf_blend_in_10|arf_make_custom_sound, pack2f(0.47, 0.82), (0,0,0), 2.19],     
   [2.1, "anim_human", blow+5400, blow+5440, arf_blend_in_16|arf_make_custom_sound, pack2f(0.47, 0.82), (0,0,0), 1.8],   
 ],
...
## ],
 ...
 ["cheer", 0, amf_play|amf_priority_mount,
   [3.0, "man_cheer", 200, 289, arf_blend_in_1],
   [4.5, "man_cheer", 300, 437, arf_blend_in_1],
   [4.5, "man_cheer", 450, 617, arf_blend_in_1],
   [3.0, "anim_human", 22500, 22527, arf_blend_in_1], 
   [3.0, "anim_human", 22600, 22627, arf_blend_in_1], 
   [3.0, "anim_human", 70000, 70045, arf_blend_in_1], 
   [3.0, "anim_human", 70100, 70150, arf_blend_in_1], 
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["crouch_unarmed", 0, amf_client_prediction,
   [4.0, "rg2_crouch_standard_xeno", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["crouch_single", 0, amf_client_prediction,
   [4.5, "rg2_crouch_standard_xeno", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["crouch_greatsword", 0, amf_client_prediction,
   [5.0, "rg2_crouch_standard_xeno", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
 ],
 ["crouch_staff", 0, amf_client_prediction,
   [4.25, "rg2_crouch_standard_xeno", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
 ["crouch_crossbow", 0, amf_client_prediction,
   [4.15, "rg2_crouch_standard_xeno", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
...
##   [0.6, "anim_human", combat+7334, combat+7340, blend_in_release],
 ...
 ["parried_thrust_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_blocked|amf_use_weapon_speed|amf_play,
   [attack_blocked_duration_thrust, "anim_human", combat+7316, combat+7313, arf_blend_in_2],
#   [attack_blocked_duration, "thrust_staff", 102, 97, arf_blend_in_2],
 ],
 ["blocked_thrust_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_parried|amf_use_weapon_speed|amf_play,
   [attack_parried_duration_thrust, "anim_human", combat+7316, combat+7313, arf_blend_in_2],
#   [attack_parried_duration, "thrust_staff", 102, 97, arf_blend_in_2],
 ],
###### RaW End  
 ...
 ["unequip_pistol_melee", 0, amf_priority_equip|amf_keep|amf_restart|amf_client_prediction,
   [0.3, "equip_pistol", 0, 10, arf_blend_in_0],
 ],
 
# Raw Begin Taunts and Warcry
 ["taunt", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
   [3.0, "man_cheer", 200, 289, arf_blend_in_1],
   [4.5, "man_cheer", 300, 437, arf_blend_in_1],
   [4.5, "man_cheer", 450, 617, arf_blend_in_1],
   [3.0, "anim_human", 22500, 22527, arf_blend_in_1], 
 ...
 # ["cover_shield", 0, amf_priority_kick|amf_client_prediction|amf_keep,
   # [3.0, "testudo_old", 0, 2,  arf_blend_in_1, 0, (0.0,0,0.0)]],  
...
# ],   
 ...
 ["cover_shield", acf_enforce_lowerbody, amf_play|amf_keep|amf_priority_mount,
    [2.0, "rg_tseudo_33frame_stand", 0, 32, arf_blend_in_5|arf_cyclic],
    [2.0, "rg_tseudo_33frame_stand1", 0, 32, arf_blend_in_5|arf_cyclic],
    [2.0, "rg_tseudo_33frame_stand2", 0, 32, arf_blend_in_5|arf_cyclic],	
  ],
  
 ["cover_shield_end", 0,amf_play|amf_priority_mount,
    [0.1, "testudo_old", 0, 1, arf_blend_in_5|arf_cyclic],
  ],  
  
 ["carnyx", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [4.0, "carnyx_anim1", 0, 40, arf_blend_in_1],
], 

 ["cornu_play", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [4.0, "cornu_play", 0, 40, arf_blend_in_1],
], 

 ["banner_taunt", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [5.0, "cifre_air_thrust2", 0, 146, arf_blend_in_1],
], 

 ["phalanx", acf_enforce_lowerbody, amf_play|amf_keep|amf_priority_mount,
    [4.0, "greatsword_cstance", 0, 91, arf_blend_in_5|arf_cyclic],
  ], 
 
   ["rider_charge",  acf_enforce_lowerbody |  acf_rot_vertical_sword, amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play|amf_keep,
    [4.0, "rider_charge", 0, 99, arf_cyclic|arf_blend_in_128], 
  ], 	
 ...
 ["duduk_play", acf_enforce_all, amf_priority_die|amf_play,
	[9.0, "duduk_anim1", 20, 64, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],], 
 ["duduk_sitting_anim", acf_enforce_all, amf_priority_die|amf_play,
	[9.0, "duduk_sitting_anim1", 20, 64, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],], 	
	
 ["trumpet_play", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [4.0, "trumpet_play", 0, 40, arf_blend_in_1],
], 
 ["horn_play", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [4.0, "horn_play", 0, 40, arf_blend_in_1],
], 	
# RaW End 

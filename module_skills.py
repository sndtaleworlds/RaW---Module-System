...
skills = [
  ...
  ("leadership","Leadership",sf_base_att_cha,15,"Every point increases maximum number of troops you can command by 25, increases your party morale and reduces troop wages by 5%%. (Leader skill)"),
  ("prisoner_management", "Prisoner Management",sf_base_att_cha,10,"Every level of this skill increases maximum number of prisoners by 15. (Leader skill)"), 

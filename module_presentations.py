    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (assign, ":cur_troop", "trp_sp_roman_princeps"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_2"),
        (assign, ":cur_troop", "trp_sp_greek_hoplites"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_3"),
        (assign, ":cur_troop", "trp_sp_celtic_argos"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_4"),
        (assign, ":cur_troop", "trp_sp_makedonian_hetairoi"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_5"),
        (assign, ":cur_troop", "trp_sp_samnite_verehia_maior"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_6"),
        (assign, ":cur_troop", "trp_sp_tarentine_leukaspides"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_7"),
        (assign, ":cur_troop", "trp_sp_syracusan_hoplite"),
      (else_try),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        (assign, ":map_image", "mesh_mp_ui_maps_new_a1"),
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_multi_scene_18"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_e2"),
      (else_try),
# RaW New scenes begin
        (eq, "$g_multiplayer_selected_map", "scn_multi_scene_19"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_e3"),
      (else_try),
      ...
      (else_try),
        ...
        (assign, ":map_image", "mesh_mp_ui_maps_new_a2"),
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_bazaar"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_a3"),	
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_hun_in_the_sun"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_a4"),	
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_pathfinder_island"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_d1"),		
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_river_delta"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_b1"),		
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_taj_apskaft"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_b2"),			
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_tilting_at_windmills"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_b3"),		
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_battle_of_the_mounds"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_b4"),	
      (else_try),
        (eq, "$g_multiplayer_selected_map", "scn_gallic_forest_fort"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_c2"),			
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_gallic_village"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_d2"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_siege_of_troy"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_c1"),		
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_chaeronea"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),		
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_geranigus_1"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_e4"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_geranigus_2"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_d3"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_geranigus_3"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_d4"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_geranigus_4"),
        (assign, ":map_image", "mesh_mp_ui_maps_new_e1"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_roman_alpine_fort"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_swamp"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),			
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_gallic_river_siege"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_gallic_river_battle"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_gallic_river_out"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),	
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_roman_villa"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),			
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_port_of_ostia"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),		
      (else_try),	
        (eq, "$g_multiplayer_selected_map", "scn_small_oppidum"),
        (assign, ":map_image", "mesh_mp_ui_host_maps_20"),			
      (else_try),
# RaW New Scenes End	  
        ...
        (eq, "$g_multiplayer_selected_map", "scn_random_multi_snow_medium"),	
        (eq, "$g_multiplayer_selected_map", "scn_random_multi_forest_medium"),			
      ...
      (assign, ":cur_y", 5240), # RaW, this makes the size of the scroller screen. Edit to higher if + troops are added
      (assign, ":cur_y_adder", 40),
      ...
      (try_begin),
        ...
        (create_number_box_overlay, "$g_presentation_obj_admin_panel_7", 5, 241),
        (position_set_x, pos1, 390),
        (position_set_y, pos1, ":cur_y"),
...
# RaW	  
      ...
      (create_text_overlay, reg0, "str_extra_encumbrance", 0),
      (position_set_x, pos1, 30),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (overlay_set_val, "$g_presentation_obj_admin_panel_43", "$g_multiplayer_extra_encumbrance"),	
	  
      (val_sub, ":cur_y", ":cur_y_adder"),

      (create_text_overlay, reg0, "str_fog", 0),
      (position_set_x, pos1, 30),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (overlay_set_val, "$g_presentation_obj_admin_panel_44", "$g_multiplayer_fog"),	  	  
# RaW	  
...
############################################################################
      ...
      (try_for_range, ":cur_troop", "trp_roman_hastatus", "trp_multiplayer_end"),
        ...
        (create_number_box_overlay, reg0, -2, 100), # RaW Changed from slider to number box
...
##        (try_end),
      ...
      (else_try),
        ...
        (multiplayer_send_int_to_server, multiplayer_event_admin_set_extra_encumbrance, ":value"),		
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_44"),
        (multiplayer_send_int_to_server, multiplayer_event_admin_set_fog, ":value"),		
      (try_end),	  
############################################################################
 # Troop Limitations Begin (From Jerkuh)
############################################################################
  ...
  ("multiplayer_troop_select", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, ":cur_y", 550), # RaW : Troop selection size, add size for more troops in menu

      (create_text_overlay, reg0, "str_choose_a_troop", 0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (position_set_x, pos1, 50), # RaW
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      (val_sub, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (call_script, "script_multiplayer_display_available_items_for_troop_and_item_classes", ":my_troop_no", multi_item_class_type_melee_weapons_begin, multi_item_class_type_melee_weapons_end, 781, 474),
      ...
      (else_try),
        ...
        (call_script, "script_multiplayer_display_available_items_for_troop_and_item_classes", ":my_troop_no", multi_item_class_type_shields_begin, multi_item_class_type_shields_end, 781, 374),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_right_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (call_script, "script_multiplayer_display_available_items_for_troop_and_item_classes", ":my_troop_no", multi_item_class_type_short_weapons_begin, multi_item_class_type_short_weapons_end, 781, 274),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_right_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
      ...
      (else_try),
        ...
        (call_script, "script_multiplayer_display_available_items_for_troop_and_item_classes", ":my_troop_no", multi_item_class_type_ranged_weapons_begin, multi_item_class_type_ranged_weapons_end, 781, 174),
        (create_mesh_overlay, reg0, "mesh_mp_inventory_right_arrow"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, reg0, pos1),
  ...
  ("multiplayer_team_score_display", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load, [
      ...
      (try_begin),
        ...
        (create_mesh_overlay, reg0, "mesh_ui_kingdom_shield_rebel"),
      (else_try),
...
##        (overlay_set_text, "$g_multiplayer_team_2_score_display_overlay", "str_s0_dd_reg0"),
  ...
  ("multiplayer_get_ban_length", prsntf_manual_end_only, 0, [
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        (eq, ":object", "$g_presentation_obj_ban_length_1"),
        (presentation_set_duration, 0),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_ban_length_2"),
        (presentation_set_duration, 0),
        (call_script, "script_cf_multiplayer_stored_player_no_is_valid"),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_for_range, ":reason_no", 0, ":num_reasons"),
        ...
        (create_button_overlay, ":overlay_id", s2, 0),
        ...
        (val_sub, ":cur_y", escape_menu_item_height),
      (try_end),
      (store_add, "$g_show_poll_reasons_list_button_list_end_index", ":overlay_id", 1),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_for_range, ":i_button", "$g_show_poll_reasons_list_button_list_first_index", "$g_show_poll_reasons_list_button_list_end_index"),
        ...
        (presentation_set_duration, 0),
        (call_script, "script_cf_multiplayer_stored_player_no_is_valid"),
        (store_sub, ":reason_no", ":object", "$g_show_poll_reasons_list_button_list_first_index"),
  ...
  ("multiplayer_get_poll_question", prsntf_manual_end_only, 0, [
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        (eq, ":object", "$g_presentation_obj_get_poll_question_1"),
  ...
  ("multiplayer_get_admin_message", prsntf_manual_end_only, 0, [
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        (eq, ":object", "$g_presentation_obj_get_admin_message_1"),
        (presentation_set_duration, 0),
        (call_script, "script_cf_multiplayer_stored_player_no_is_valid"),
  ...
  ("helmet_view", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
	  ...
	  (try_begin),
		(troop_has_item_equipped, "trp_player", "itm_samnite_attic"), 
...
# Raw Edit:			
            (troop_get_slot, ":upgrade_troop", "$g_talk_troop", slot_troop_barrack_upgrade),	
        ...
        (try_begin),
          ...
          (position_set_x, pos1, 1550), # was 1750
          (position_set_y, pos1, 1750),
          (overlay_set_size, "$g_presentation_obj_6", pos1),
          (position_set_x, pos1, 50),
          (position_set_y, pos1, 240),
...
# RaW Edit:			
          ...
          (party_set_slot, "$current_town", slot_center_barrack_troops, "$g_talk_troop_relation"),

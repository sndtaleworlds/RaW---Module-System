...
# Epirus
  ...
  (
    ...
    [(assign, reg3, "$character_gender"),],
    [
      ("roman_princeps",[],"Roman Princeps.",[
        (assign,"$background_answer_2",cb2_roman_princeps),
      (str_store_string,s11,"@As a middle-class Roman citizen you fight as a Princeps with sword, scutum and pilum."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),			
      ("greek_hoplite",[],"Greek Hoplitès.",[
        (assign,"$background_answer_2",cb2_greek_hoplite),
      (str_store_string,s11,"@As a Hoplite you are outfitted with a simple linothorax, a doru, an aspis and a sword."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),
      ("cretan_archer",[],"Cretan Toxotes.",[
        (assign,"$background_answer_2",cb2_cretan_archer),
      (str_store_string,s11,"@Cretans have a long history of renowned archers and you're no exception."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),			
      ("gallic_gaisatos",[],"Gallic Gaisatos.",[
        (assign,"$background_answer_2",cb2_celtic_gaisatos),
      (str_store_string,s11,"@Sometimes courage is the best armour, and none are braver as the Gaisatos."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),
      ("macedonian_phalangite",[],"Macedonian Phalangite.",[
        (assign,"$background_answer_2",cb2_macedonian_phalangite),
      (str_store_string,s11,"@Some may say you're overcompensating but none can argue with the results brought by the sarissa."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),
      ("thessalian_horseman",[],"Thessalian Hippeus.",[
        (assign,"$background_answer_2",cb2_thessalian_horseman),
      (str_store_string,s11,"@The best horsemen of Greece are in Thessaly."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),	
      ("samnite_footman",[],"Samnite Pedú.",[
        (assign,"$background_answer_2",cb2_samnite_pedu),
      (str_store_string,s11,"@Hardy men from the mountainous region of Samnium taught the Romans the value of the manipular formation."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),
      ("tarentine_horseman",[],"Tarentine Hippakontistés.",[
        (assign,"$background_answer_2",cb2_tarantine_hippakontistes),
      (str_store_string,s11,"@Tarentine cavalry is a reference in terms of mounted skirmishers, so much that it has become a byword in Greece."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),	
      ("illyrian_hoplite",[],"Illyrian Hoplitès.",[
        (assign,"$background_answer_2",cb2_illyrian_raider),
      (str_store_string,s11,"@Even fearsome tribes and raiders know the value of a phalanx."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),	
      ("etruscan_axeman",[],"Etruscan Luvcatru.",[
        (assign,"$background_answer_2",cb2_etruscan_luvcatru),
      (str_store_string,s11,"@Built to disrupt formations and break shields, the fearsome Etruscan axeman can deal with almost anything as long as it is in melee range."),
	(jump_to_menu,"mnu_select_initial_renown"),
        ]),			
      ("go_back",[],"Go back.",
       [(jump_to_menu,"mnu_start_character_1"),
 ...
 and these debts can only be paid in blood..."),
      ...
      (str_store_string,s11,"@You are a merchant, your only god is coin, you'll do anything to have more and you will keep it no matter the costs..."),
        (jump_to_menu,"mnu_select_initial_renown"),
        ]),
      ("go_back",[],"Go back.",
       [(jump_to_menu,"mnu_start_character_1"),

...
[
 ...
 (2, #Error check for multiple parties on the map
	...
	(try_for_parties, ":party_no"),
		...
		(try_end),
		##diplomacy end+
		(str_store_string, s65, "str_party_with_commander_mismatch_check_log_for_details_"),
...
#          (display_message, "@{!}Cattle in {s1} are exterminated due to famine."),
            ...
            (try_begin),
              ...
              (try_begin),
                ...
                (try_begin),
                  ...
                  (party_add_members, ":center_no", "trp_caravan_guard", ":random"),
  ...
  # [
      # (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
	  # (call_script, "script_raw_castle_recruits", ":center_no"),  
   # ]),
...
(0,
   # [(party_get_current_terrain,":terrain","p_main_party"),(assign,reg1,":terrain")], # rt_steppe is an example for the name of your new water terrain
   [(try_begin),
 ...
 #Update how good a target player is for bandits
  ...
  (72,
   [
     ...
     (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
       (call_script, "script_update_troops_in_barracks", ":center_no"),
     (try_end),	 
    ]),
 ...
 (0.5,
   ...
   (try_for_parties, ":party_no"),
      ...
      (try_begin),
         ...
         (assign, reg10, ":needed"),
         (display_log_message, "@Your recruiter who was commissioned to recruit {reg10} recruits to {s13} has been defeated! Trigger", 0xFF0000),
         (remove_party, ":party_no"),
         (assign, ":quit", 1),
      (try_end),

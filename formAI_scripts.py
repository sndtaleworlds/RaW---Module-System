...
# (display_message, "@Time {reg2}: Infantry of team {reg0} rushing archers"),
			...
			(else_try),
				...
				(try_begin),
					...
					(try_begin),
						...
						(else_try),
							...
							(assign, ":infantry_formation", formation_square), # RaW was formation wedge
						(try_end),
					(try_end),
				...
				(try_begin),
					...
					(val_div, ":spacing", 25),	#from seeing that weapons of about 100 need 3x50 extra spacing # RaW was 33

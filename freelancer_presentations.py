  ...
  ("taragoth_lords_report", 0, mesh_load_window, [
	...
	[
		...
		(else_try),
			...
			(create_mesh_overlay, reg0, "mesh_pic_arms_taras"),            
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_7"),
			(create_mesh_overlay, reg0, "mesh_pic_arms_syracuse"),            
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_8"),
			(create_mesh_overlay, reg0, "mesh_pic_arms_epeiros"),            
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_9"),
			(create_mesh_overlay, reg0, "mesh_pic_arms_etruscan"),            
		(try_end),

...
man_face_keys = [
(20,0, .2,-0.6, "Chin Size"),
(260,0, -0.4,1.2, "Chin Shape"),
(10,0,-0.4,0.8, "Chin Forward"),
(240,0,0.6,-0.4, "Jaw Width"),
(210,0,-0.3,1.0, "Jaw Position"),
(250,0,1.2,-0.1, "Mouth-Nose Distance"),
(200,0,-0.2,0.5, "Mouth Width"),
(50,0,-1.0,0.8, "Cheeks"),

(60,0,-0.2,1.0, "Nose Height"),
(70,0,-0.3,0.2, "Nose Width"),
(80,0,0.8,0.2, "Nose Size"),
(270,0,-0.3,0.6, "Nose Shape"),
(90,0,-0.1,1.2, "Nose Bridge"),

(100,0,-0.2,1.0, "Cheek Bones"),
(150,0,0.1,2.0, "Eye Width"),
(110,0,1.0,-0.6, "Eye to Eye Dist"),
...
(30,0,-0.1,0.6, "Face Depth"),
(40,0,0.6,-0.4, "Face Ratio"),
(190,0,0.0,0.7, "Face Width"),
...
skins = [
  (
	...
	"man_hair_headband_b",
	"man_hair_headband_2",
	"man_hair_headband_2_a",
	"man_hair_headband_2_b",
	"man_hair_laurel",
], #man_hair_meshes
    [
	"beard_g",
	...
	"beard_p", #big bush	
	"beard_y", #huge
	"beard_r", #small stache
	"beard_a", #small medium	
	"beard_e", #medium	
	"beard_b", #medium	
	"beard_c", #medium long	
	"beard_t", #large 

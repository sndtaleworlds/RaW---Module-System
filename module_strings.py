...
##  ("nothing", "nothing"),
  ...
  ("tutorial_map1","Greetings adventurer to the Rome at War mod ! Before you wonder how to recruit troops let me explain it to you, you will need to go to a village and talk to the village overseer and ask him for the available troops, from there you will access to a units menu. Simple isn't it? Oh and there are tons of different units to recruit, get 'em all! Greetings from the Rome at War team: Rgcotl, Gothic Knight, Seek n Destroy, KickingJoub, Nistrum, Theretor. Special thanks to the Athenai clan for testing the mod before releases !"),
...
#NPC strings
#npc1 = Amyntas ho Makedon
#npc2 = Stenis Saluatur
#npc3 = Deimos
#npc4 = Abrupolis
#npc5 = Erasmus
#npc6 = Perkens Metiis
#npc7 = Theron
#npc8 = Leonides
#npc9 = Camillus Licinius Varus
#npc10 = Thalès ho Dodona
#npc11 = Sepis
#npc12 = Simmias ho Phársalos
#npc13 = Joubas ho Athinaíos
#npc14 = lazalit
#npc15 = artimenner
#npc16 = klethi

  ("npc1_intro", "Hail traveller! Care to share a drink with a veteran of many wars? I might entertain you with a story or two..."),
  ("npc2_intro", "Here to pay a drink to a mighty champion?"),
  ("npc3_intro", "Word is you're looking for warriors."),
  ("npc4_intro", "What do you want?"),
  ("npc5_intro", "Greetings, traveller. I see you have quite the escort with you, care to have a drink?"),
  ("npc6_intro", "No offense but you don't exactly look like the right audience for me. If you insist maybe I know a Greek drinking song or two but that's a poor use of my talents."),
  ("npc7_intro", "Tell me stranger, do you enjoy hunting?"),
  ("npc8_intro", "Are you too one of the poor sods like me that signed up for 'riches and adventure'? I'm barely being paid a coin neither am I getting any action here. Worst of all, the wine tastes like piss."),
  ("npc9_intro", "I'm Camillus from the Varus branch of the gens Licinia, one of the prestigious Roman families. You look like the capable sort, would you be interested in joining my mercenary company?"),
  ("npc10_intro", "Psst, hey you, come here discretly."),
  ("npc11_intro", "I need a drink but I'm all out of gold, would you be so kind stranger as to pay for my next drink?"),
  ("npc12_intro", "I don't suppose you're looking for officers, are you?"),
  ...
  ("npc15_intro", "Greetings traveller, my name is Timaeus and I am a historian. With the wars breaking all too often I've been stuck here for some days, would you be perhaps heading out?"),
  ...
  ("npc3_intro_response_1", "It deprends, who's asking?"),
  ("npc4_intro_response_1", "Not sure, who are you exactly?"),
  ("npc5_intro_response_1", "Certainly. With whom do I have the pleasure of drinking?"),
  ("npc6_intro_response_1", "I'm sorry what do you do exactly?"),
  ("npc7_intro_response_1", "I do enjoy the occasional hunt, what do you hunt?"),
  ("npc8_intro_response_1", "Just passing through, what adventure did you sign up for?"),
  ("npc9_intro_response_1", "I have my own company, perhaps we could join forces?"),
  ("npc10_intro_response_1", "What do you want?"),
  ("npc11_intro_response_1", "Alright, what's the matter for all the drinking?"),
  ("npc12_intro_response_1", "Maybe I am, I thought officers were never out of work?"),
  ...
  ("npc3_intro_response_2", "Yes, shame I don't see any here."),
  ("npc4_intro_response_2", "Just looking for where that stench is coming from."),
  ("npc5_intro_response_2", "I'm not accepting drinks from strangers."),
  ("npc6_intro_response_2", "Not here for songs, goodbye."),
  ("npc7_intro_response_2", "I'm not in the mood for pointless conversation."),
  ("npc8_intro_response_2", "Honestly, I'm just concerned that you know what piss tastes like."),
  ("npc9_intro_response_2", "I'm not the type to follow orders from some kid."),
  ("npc10_intro_response_2", "I don't think so."),
  ("npc11_intro_response_2", "I'm not exactly the charitable kind."),
  ("npc12_intro_response_2", "I'm not."),
...
#backstory intro
  ...
  ("npc2_backstory_a", "I would wager you've never been to Capua then, else you would certainly have heard of me. Allow me to introduce myself. I'm Stenis Salauatur, champion of Capua, hailing from the fierce Hirpini tribe. Well... I used to be all that..."),
  ("npc3_backstory_a", "Deimos."),
  ("npc4_backstory_a", "Abrupolis of the Odrysians, son of Adaeus and currently looking for a warband or raiding party."),
  ("npc5_backstory_a", "I'm Erasmus, a humble merchant from Taras. I was doing quite well for myself but my most daring business adventure yet has left me destitute."),
  ("npc6_backstory_a", "Are you one of the woods people or just been living under a rock? Don't you know what a bard is? I'm sure even the most backwards tribes out there have at least a storyteller or someone that sings."),
  ("npc7_backstory_a", "Only the most dangerous of predators, wolves, lions and... men. They all have their weaknesses, a wise hunter will know how to best exploit them."),
  ("npc8_backstory_a", "The local rulers started recruiting mercenaries such as myself in great numbers, the pay isn't great but they promise loot. I've been here for weeks and nothing happened."),
  ("npc9_backstory_a", "Oh it's actually just me for the moment, I had recruited some men from this very tavern but as soon as I paid them, they dissappeared!"),
  ("npc10_backstory_a", "It's a long story, but I need someone to smuggle me out of here."),
  ("npc11_backstory_a", "I'm a simple shepherd from Lucania {sir/madam} but I've been left destitute by the war that broke out between my people and the Greek colonies..."),
  ("npc12_backstory_a", "It so happens that I am, due to a stupid incident. I commanded a small detachment of Thessalian cavalry for the Macedonians but one of my subordinates kept undermining my authority."),
  ...
  ("npc15_backstory_a", "Well {sir/madame}, I used to work in the palaces of Hellenic Basileios but my last contract did not end well."),
...
#backstory main body
  ...
  ("npc2_backstory_b", "You may wonder, how did such a great champion end up here? It's a long story but unless you keep me supplied with drinks I will cut it short. The tribes of Samnium went to war with the Campanians and for a while things were going our way. That is, until they allied with the Romans. There were some victories and some defeats, the later saw me and some of my kin being captured and sold into slavery in Capua but it wasn't the end of it. Far from it."),
  ("npc3_backstory_b", "I'm a Lakedaimonian."),
  ("npc4_backstory_b", "My previous raiding party disbanded after our last raid. Not because of it of course, we were good at it. We had years of practice raiding rival tribes and sometimes the Macedonians that settled a bit too close to Thracian lands. It's just that our village was burnt to the ground as we were away on a raid. With nothing to come back to and no means to exact revenge we all just went our separate ways."),
  ("npc5_backstory_b", "I invested all I had to acquire Tyrian dyes, Campanian wine, clothes and furs from the various Italian tribes and loaded it on a ship on its way to Greece. Unfortunately we were ambushed by a fleet of Illyrian pirates."),
  ("npc6_backstory_b", "I'm all that, and much more. I recite or sing some of the best plays ever written and complement them with my own material. I have been part of some of the most prestigious courts in the world but I later found out that meddling with politics is dangerous business..."),
  ("npc7_backstory_b", "Take the wolves for instance, they are very dangerous in a pack but if you isolate them from the pack they are easy to kill. Lions? They are tough and many men have fallen prey to them thinking themselves to be stronger. You need to tire them out, what the lion has in raw strenght, it lacks in endurance. Chase it until he falls from exhaustion and then you can take him out with relative ease."),
  ("npc8_backstory_b", "The rest are sitting on their asses too, they get bored so they go around causing trouble. I mean, can't blame them. A few more days of doing nothing and I might just start a fire to fight the boredom."),
  ("npc9_backstory_b", "This really put a dent on my finances, I expected to do some caravan contracts with the few men I had enlisted which should pay enough to slowly grow my mercenary army. I'm starting to run out of options now and the shame of going back home would be simply too great."),
  ("npc10_backstory_b", "I'll give you the short story, I'm not a criminal, I'm just a political hostage and I want my freedom back."),
  ("npc11_backstory_b", "For 20 years I have tended to my flock and stayed out of trouble but it still found me nonetheless. I have no stakes in this war, I just wanted to live my life peacefully but all has been taken from me."),
  ("npc12_backstory_b", "Understand that I couldn't get the bastard flogged because, as is the case with most members of a cavalry unit, he comes from a wealthy family. A very influential one compared to mine. I let him get cocky on purpose and asked him if he'd like to challenge me in a fist fight for my position, as per tradition."),
...
#backstory recruit pitch
  ...
  ("npc2_backstory_c", "The Campanians wanted to celebrate their victory and what more entertaining than making your enemies fight to the death for your entertainment? They pitted me and my kin against each other until only one would stand, with promises of freedom to the victor. You can guess where this went. My life was at stake and I did what I had to do to survive. The bastards didn't grant me the freedom they promised, instead they liked their little games so much that they turned it in something regular, everything was an excuse for me to fight some poor sod until one of us fell to his demise."),
  ("npc3_backstory_c", "... I need work."),
  ("npc4_backstory_c", "I considered going out on a blaze of glory and make my ancestors proud... I still might just do that but I wanted to see more of the world first. Maybe I will make my own tribe but first I need work."),
  ("npc5_backstory_c", "I tried to negotiate with them but to no avail. They took all they could carry with them and sank the ship. I was lucky that the shore wasn't too far, I'm not a great swimmer but with the aid of an empty barrel I managed to reach the land. I've been on the move ever since trying to survive, now I believe my good fortune is returning. I think we might be able to help each other."),
  ("npc6_backstory_c", "Now look at me, telling my life story to a complete stranger... What did you want from me anyway?"),
  ("npc7_backstory_c", "Last and not least, there's man. There are many creative ways to take them out, some work better than others. I can see this is the part that interests you the most, lucky for you there is much I can tell about it... for a price."),
  ("npc8_backstory_c", "The whole thing stinks too, they hired us as if they expected a war that didn't happen and now they don't know how to deal with us. I've heard some mercenaries dissappeared recently, some say they just left, others say they were murdered so the locals don't have to pay them anymore. I don't think I'm sticking here long enough to find out."),
  ("npc9_backstory_c", "My father is the poorest out of all his siblings and only owns a small estate, he invested what he could on my brother so he could do his military service while me and my sisters would manage his estate. I didn't want to sspend my whole life in the same place and I wanted to prove my father I'm worth the same, if not more, as my brother. So I borrowed some of his wealth without him knowing and set out to make a name for myself."),
  ("npc10_backstory_c", "When Alexander of Epirus died, the Macedonians collected members from the proeminent Epirote families to ensure our loyalty. I grew far away from home and I can't stand it anymore so I escaped. I think my captors are after me and I need help to escape."),
  ("npc11_backstory_c", "I was off to sell wool and cheese to Metapontion and when I came back a Greek expedition army was camping nearby my farm. They accused me of smuggling weapons to the Lucanians using my sheep and put my flock to the sword and rosted it before my very eyes and there was nothing I could do about it..."),
  ("npc12_backstory_c", "Of course, being the idiot he is, he accepted. I only planned to humiliate him so he'd stop bothering me but I ended up letting my anger get the best of me. And wouldn't you know, the bastard drops dead after a punch to the nose. I had to leave the army after that or his family would certainly come after me..."),
...
### use these if there is a short period of time between the last meeting
  ("npc1_backstory_later", "I've been telling tales from tavern to tavern, sometimes begging at the temples, offering protection services to caravans or travelling nobles. Nothing remotely exciting nor earning enough to finally retire. Not that I know anything about farming, the closest I got to that life was digging graves and huh… a farmer’s wife."),
  ("npc2_backstory_later", "Since they managed to put my name to shame I can't pursuit this carreer anymore and I'm going to do mercenary work eventually."),
  ("npc3_backstory_later", "I still need work."),
  ("npc4_backstory_later", "I've been here and about, you know, doing my best to keep out of trouble. I'm desperately in need of work, however."),
  ("npc5_backstory_later", "I've been peddling goods trying to survive, but I need more than that to get back on business."),
  ("npc6_backstory_later", "Always on the move, I've made some powerful enemies so it's not safe for me to travel alone or stay too long in one place."),
  ("npc7_backstory_later", "The hunt never stops, stranger. The hunter never rests either if he is to be successful."),
  ("npc8_backstory_later", "I left that wretched place but here doesn't seem to be any better. Harsh times for a mercenary it would seem."),
  ("npc9_backstory_later", "I'm travelling around looking for affordable opportunities but it's barely enough to keep me fed."),
  ("npc10_backstory_later", "I still need your help if you're interested, I've managed to elude my captors so far but I don't think I can keep doing it on my own."),
  ("npc11_backstory_later", "I'm off to drink myself to death. Poor sheep..."),
  ("npc12_backstory_later", "I'm still looking for work if you know anyone that could use an officer."),
  ...
  ("npc2_backstory_response_1", "Well, perhaps I could offer you work."),
  ("npc3_backstory_response_1", "Right... I might consider you but you have to tell me how you ended up here 'Spartan'."),
  ("npc4_backstory_response_1", "I do have a small warband of my own, perhaps you would like to join?"),
  ("npc5_backstory_response_1", "I might agree, if you convince me."),
  ("npc6_backstory_response_1", "I could use someone with your kind of connections and... talents."),
  ("npc7_backstory_response_1", "Hmm... Tell me a bit more about yourself and I'll consider employing you."),
  ("npc8_backstory_response_1", "I think I can match up their offer and actually deliver on that promise."),
  ("npc9_backstory_response_1", "All I care about is if you can fight."),
  ("npc10_backstory_response_1", "I could pass you out as one of my soldiers."),
  ("npc11_backstory_response_1", "What will you do now?"),
  ("npc12_backstory_response_1", "I appreciate your honesty, come work for me if you can follow orders."),
  ...
  ("npc3_backstory_response_2", "You're boring me, I'm out."),
  ("npc4_backstory_response_2", "Though luck. I'm not looking to hire savages."),
  ("npc5_backstory_response_2", "I have no use for a merchant."),
  ("npc6_backstory_response_2", "Nothing really."),
  ("npc7_backstory_response_2", "I've heard more convincing speeches from the local madman."),
  ("npc8_backstory_response_2", "Though times lad."),
  ("npc9_backstory_response_2", "Boo-hoo. Tough life kid, most people don't have it as good and don't whine half as much."),
  ("npc10_backstory_response_2", "I'm not risking it, good luck anyway."),
  ("npc11_backstory_response_2", "That's the worst sob story I've heard so far."),
  ("npc12_backstory_response_2", "I don't take murderers."),
  ...
  ("npc3_signup", "Failed the Agoge. ^[you motion him to continue talking] ^Task was to kill helots. I didn't."),
  ("npc4_signup", "Mhm. Not sure if I'm comfortable being in a large warband. I'm more used to quick raids with a handful of mostly trustworthy warriors."),
  ("npc5_signup", "Of course! As I told you, I'm a merchant and were it not for the aforementioned incident I would be amongst the wealthiest of Taras. Fortune wished it otherwise but I still have my uses."),
  ("npc6_signup", "I hadn't considered your line of work until now but I must confess that the warrior-poet title would do wonders to my reputation."),
  ("npc7_signup", "You may call me Theron if that pleases you. I hail from the island of Crete, we're all born natural hunters but only the best make it out of there. Most fall for the pirate life but never amount to anything but a feast for Poseidon's creatures."),
  ("npc8_signup", "Now we're talking, I'll take any chance to leave this place. Name's Leonides by the way, really nice to make your acquaintance."),
  ("npc9_signup", "I used to train with my brother before he joined the army. I didn't end up joining because you have to purchase your own equipment and my father prefered to pay for decent equipment for my brother rather than something more affordable for the both of us."),
  ("npc10_signup", "I'm out of options so I guess I'll take that chance."),
  ("npc11_signup", "I was planning to drink myself to death but I've already gone through my savings."),
  ("npc12_signup", "Of course, I'm used to take on orders in the army. I expect to be giving out orders as well considering my status and I expect those you put under my command to follow them, consider me an extention of you command."),
  ...
  ("npc3_signup_2", "[You keep staring expecting him to finish his story] ^I don't kill women and children. No problem killing men."),
  ("npc4_signup_2", "I guess I'll just have to get used to it. I'll follow your orders but I expect you to follow my advice when it comes to raiding."),
  ("npc5_signup_2", "I saw that you're leading a small army and I bet you need someone to help finance it. I can haggle for provisions and trade goods for you and help managing the expenses. I can assure you my help in invaluable, you will pay less and earn more. Not an offer that can be refused!"),
  ("npc6_signup_2", "I had some fighting classes in the past, let's see if I still remember a thing or two. I'm sure it will come back to me with some practice."),
  ("npc7_signup_2", "Others sell their talents as mercenaries as there is always need of good archers and raiders. I did all that and now I'm looking for a new hunting party and you seem to have potential to become a good hunter."),
  ("npc8_signup_2", "I come from the island of Rhodes and have been training to fight since I was a child. I'm not much of a fighter in close combat, I certainly can handle myself well enough to survive a scratch or two but what I excel at is cracking skulls at a distance with my sling."),
  ("npc9_signup_2", "I think he also didn't both his sons to risk their lives as most of our grandfather's brothers perished fighting the invading Gauls. Not doing military service severely limits the political opportunities one might have in Rome, which is what I am most dissatisfied about."),
  ("npc10_signup_2", "I think I will stick around with your company for a while if you don't mind, until they give up looking for me."),
  ("npc11_signup_2", "I'm just so angry that I feel like killing the next Greek that enters this tavern but I don't think I have it in me."),
  ("npc12_signup_2", "Now, point me to your camp and present me to those I should get acquanted with."),
  ...
  ("npc3_signup_response_1", "Same for me, you're hired."),
  ("npc4_signup_response_1", "Fair enough. You can join us."),
  ("npc5_signup_response_1", "I certainly can use some help with finances."),
  ("npc6_signup_response_1", "Great, pack your things now. We're moving out soon."),
  ("npc7_signup_response_1", "Alright, I'll give you a chance to back that up."),
  ("npc8_signup_response_1", "Splendid, consider yourself hired."),
  ("npc9_signup_response_1", "Well, you can start to earn your keep here."),
  ("npc10_signup_response_1", "Fine by me, I hope you can fight."),
  ("npc11_signup_response_1", "You could join my company and put that anger to good use and pick up some skills."),
  ("npc12_signup_response_1", "Right this way."),
...
#11
  ...
  ("npc2_signup_response_2", "I don't think I can agree to that."),
  ("npc3_signup_response_2", "A Spartan with a conscience? Haha, no."),
  ("npc4_signup_response_2", "I'm not letting you in charge of anything. Goodbye."),
  ("npc5_signup_response_2", "I already have someone that takes care of that. Bye."),
  ("npc6_signup_response_2", "Actually, that might just be a terrible idea. Let me think some more."),
  ("npc7_signup_response_2", "Another washed-up Cretan pirate looking for someone gullible. No thanks."),
  ("npc8_signup_response_2", "I actually despise slingers, better luck next time."),
  ("npc9_signup_response_2", "I'm not exactly convinced, let me think some more about it."),
  ("npc10_signup_response_2", "Not worth the risk."),
  ("npc11_signup_response_2", "I don't think you have it in you either."),
  ("npc12_signup_response_2", "On second thought, let me reconsider."),
  ...
  ("npc2_payment", "{!}."),
  ("npc3_payment", "{!}."),
  ("npc4_payment", "As I said earlier, I will work but for a price. {reg3} gold and I'm in."),
  ("npc5_payment", "Wise choice! Now, I will need {reg3} gold to get me started. I will need to purchase some supplies for the camp."),
  ("npc6_payment", "{!}."),
  ("npc7_payment", "Trade secrets come at a cost, I'd say {reg3} gold is a reasonable price to start with. Consider that an up front payment for my tutoring."),
  ("npc8_payment", "Right, well they promised me {reg3} gold which I've only seen a fraction of which I ended up spending in this tavern. You said you'd match that offer right?"),
  ("npc9_payment", "Thank you. Speaking of earning my keep, I desperately need some gold right now since those rascals ran out with their pay without delivering any of the services I asked. I would need {reg3} gold if you may."),
  ("npc10_payment", "One more thing, I think bribing the tavern keeper would help keeping my former captors at bay. I think for {reg3} gold he'd accept."),
  ("npc11_payment", "If I were sober I'd tell you to piss off but what else is there for me? Pay my tab, I think it's {reg3} gold or something and I'll follow you."),
  ("npc12_payment", "{!}."),
  ...
  ("npc15_payment", "You won't regret taking me aboard {sir/madame}. Unfortunately I have ran out of scrolls and ink, so if you could lend me {reg3} denarii?"),
  ...
  ("npc4_payment_response", "Very well, here's {reg3} gold. Now, fall in with the rest."),
  ("npc5_payment_response", "Here's your payment."),
  ("npc6_payment_response", "{!}."),
  ("npc7_payment_response", "Fine, here's the {reg3} gold."),
  ("npc8_payment_response", "Of course, here's {reg3} gold."),
  ("npc9_payment_response", "Very well, here's {reg3} gold."),
  ("npc10_payment_response", "Good idea. Here, {reg3} gold."),
  ...
  ("npc14_payment_response", "All right, here's {reg3} gold."),
  ("npc15_payment_response", "Very well, here's {reg3} gold, can't have a scribe without scrolls and ink."),
  ("npc16_payment_response", "All right, here's {reg3} gold for you. Make yourself ready."),

  ("npc1_morality_speech", "This brings back terrible memories of Ipsos that we {s21}. I hope that's the last time this happens as I don't know if I can keep going for much longer."),
  ("npc2_morality_speech", "Not again... I can't take the fact that we {s21}. Be more cautious in the future or I'll make sure to not be around when another such disaster is on its way."),
  ("npc3_morality_speech", "We {s21}. I don't approve."),
  ("npc4_morality_speech", "Just so you know, I'm not in to {s21}. I'm out if it happens again."),
  ("npc5_morality_speech", "Pardon me, captain. It is not good to {s21}. Such a waste of life..."),
  ("npc6_morality_speech", "Excuse me, {sir/madame}. As you know, I joined with you to right wrongs, improve my reputation and influence. I did not expect to {s21}."),
  ("npc7_morality_speech", "Had you asked for advice I would have said this was a bad move that would result in {s21}. Which is exactly what happened. I hope this is a lesson learned for the future."),
  ...
  ("npc9_morality_speech", "{Sir/Madame} It is not our way to {s21}. Men of my gens will accept death but not dishonour. Please do not make me ashamed to serve under you."),
  ...
  ("npc11_morality_speech", "Off we are ruining the life of poor people by {s21}. Ain't there enough misery in the world already?"),
  ("npc12_morality_speech", "I didn't sign up to {s21}. I am a nobleman after all, not a common brigand nor do I want to be in the company of such."),
  ...
  ("npc2_2ary_morality_speech", "Captain. I find it distasteful that we {s21}. I have always been a man of my word and this is testing my resolve."),
  ("npc3_2ary_morality_speech", "It's fine to {s21} if we have to."),
  ("npc4_2ary_morality_speech", "Don't listed to the rest, it's fine if you have to {s21}. Sometimes it's what it takes to survive."),
  ...
  ("npc9_2ary_morality_speech", "Captain, I am dismayed that you {s21}. Honour matters very much to me and I find those acts reprehensible."),
  ("npc10_2ary_morality_speech", "Captain, I think it's crueld to {s21}. You should treat your men well, and they'll repay with interest."),
  ...
  ("npc14_2ary_morality_speech", "You should not let it bother you that you {s21}. The men should know to toughen up and fight harder."),
  ...
  ("npc1_personalityclash_speech", "{Lad/Lass}, as per usual I was with the troops entertaining them with one of my many interesting stories until that rude, dull and foul-smelling Thracian that calls himself {s11} interrupted me with a fart."),
  ("npc2_personalityclash_speech", "Captain, {s11} is a cunt. That Roman bastard barely stopped suckling on his mother's tits yesterday and already acts as if he is better than the rest of us. He keeps invoking his family name as if it meant anything to anyone other than himself."),
  ("npc3_personalityclash_speech", "Keep {s11} away. He's weak and makes you weak."),
  ("npc4_personalityclash_speech", "We should get rid of {s11}, the old man is just slowing us down with his nonsense. He's practically senile as it is, there's no point in keeping him with us."),
  ("npc5_personalityclash_speech", "Is it just me or {s11} is just bullying everyone that crosses his path?"),
  ("npc6_personalityclash_speech", "Excuse me, {sir/madame}, but what exactly is going on with that Cretan mercenary of yours? {s11} is his name I think. He's rude, crude, nasty, brutish and selfish."),
  ("npc7_personalityclash_speech", "The bard, {s11}, he's more concerned about his appearance than looking out for danger. His distraction might not bring harm only to him but for the rest of us."),
  ("npc8_personalityclash_speech", "Excuse me there Captain but that shephed has no business telling me how to fight and which targets to pick."),
  ("npc9_personalityclash_speech", "If the Thessalian, {s11} keeps badmouthing me don't be surprised if he happens to fall from his horse with a javelin stuck in his ribs next time we battle."),
  ...
  ("npc1_personalityclash_speech_b", "I didn't heed it much attention other than telling my story on why one should never fart on a fireplace until he tried to silence me. I told him that Thracians never achieved anything worth of a story other than fucking a goat. To which he responded by calling my mother a goat! I hope he trips and falls on his own weapon."),
  ("npc2_personalityclash_speech_b", "Which I assure you doesn't mean shit. If it was that great of a family maybe he wouldn't be here crying about his daddy issues. If he gloats again about purging the Samnites maybe I will indulge him a duel. I can't promise that I won't kill him if he accepts."),
  ("npc3_personalityclash_speech_b", "That's all I have to say."),
  ("npc4_personalityclash_speech_b", "Back in my village he would either have to step down from his position or he would be challenged for it. I'm fine with both options but if the first one is taking too long I might just go for the second one."),
  ("npc5_personalityclash_speech_b", "He doesn't talk much but when he does it's to insult someone. Just the other day he told me 'Piss off merchant, you're no real warrior', which was uncalled for. You should keep an eye on him."),
  ("npc6_personalityclash_speech_b", "Just about now he complimented my buttocks, saying it was as a ripe peach. I'd normally consider it a flattering comment but what followed it was so disgusting that I don't dare repeat it."),
  ("npc7_personalityclash_speech_b", "Need I to remind you that a pack is only as strong as their weakest member? We should weed out the weak or destiny will have it, often at a cost."),
  ("npc8_personalityclash_speech_b", "Tell {s11} that I've been fighting for as long as he's been shagging his sheep and that I need no advice from him."),
  ("npc9_personalityclash_speech_b", "Just because he knows my family isn't as wealthy as his he takes every opportunity he gets to call me poor and display his own wealth in front of me."),
...
### set off by behavior after victorious battle
  ("npc1_personalityclash2_speech", "{Lad/Lass}, let me tell you about {s11} for I know his kind. I've seen lots of them throughout the years, especially while serving under Alexander. While there is a funny story about that, it is beside the point I'm trying to make. This time I will cut it short."),
  ("npc2_personalityclash2_speech", "Captain. {s11} is getting on my nerves and if his behavior doesn't change things will get ugly. First he starts ranting that Greeks ought to civilize the tribes, by force if necessary."),
  ("npc3_personalityclash2_speech", "This {s11} is a fool, you should get rid of him."),
  ("npc4_personalityclash2_speech", "That Greek trader, {s11}, he's as useless as he is irritating. Since he can barely fight to save himself he just relies on me to survive."),
  ("npc5_personalityclash2_speech", "I'm quite revolted that you chose {s11} as a companion. He's no better than a common thief and quite rude."),
  ("npc6_personalityclash2_speech", "The Spartan, {s11}, he has quite the temper doesn't he? I didn't mind the quiet act of his, quite the contrary. I would sit by the campfire and recite some stories which, without saying a word, he seemed to enjoy."),
  ("npc7_personalityclash2_speech", "Horses are great companions and great tools when used properly. {s11} might know how to ride one but he doesn't know how to use it. He's so hungry for fame and glory that he disregards proper tactics and just charges in as if there was no tomorrow."),
  ("npc8_personalityclash2_speech", "The wee Roman boy, {s11} fancies himself a leader all of the sudden. He's not even giving orders in your name, not that I can tell. He just decided all of a sudden that his upbringing grants him the right to give out orders."),
  ("npc9_personalityclash2_speech", "{s11}'s hate towards Romans is quite apparent but it's normal coming from the mountain folks. They are simply jealous of how we are superior to them in every way."),
  ...
  ("npc1_personalityclash2_speech_b", "His kind worships nothing but power, all he sees around him are pawns and tools to achieve said power. For they believe to be above the common man and would do anything to distance themselves from their brethren. You cannot, should not, trust him. He will betray you at the first opportunity he gets if it benefits him."),
  ("npc2_personalityclash2_speech_b", "I'd love to see the bastards try, each time a war erupts it's just a matter of time until they need to call on their allies to save them. Then he went on to add that it's a shame I'm no longer fighting for entertainment and that it would bring in a good crownd if opened to the public. Another comment like that and he's getting the most entertaining slap to the face in his life."), #marnid - alayen
  ("npc3_personalityclash2_speech_b", "I can do it for you. Just say the word."),#Ymira - matheld
  ("npc4_personalityclash2_speech_b", "You may have heard him yelling 'Savage, there's one on my right' or some variation of that for most of the battle. If he keeps at it, the next time you see him he will be lying belly down with a javelin stuck in the base of his neck."),#Rolf - deshavi
  ("npc5_personalityclash2_speech_b", "I was sharing my story with him just to make conversation and all he thought to say was that the Illyrian pirates are amateurs compared to the Cretans. That had I ran into Cretan pirates I would be long dead or sold into slavery. Who even says that to someone that went through such a traumatic experience?"), #beheshtur- katrin
  ("npc6_personalityclash2_speech_b", "I told him I liked his quiet and brooding act and offered for him to join my tent so I would put a smile on his face for once. What followed was just a hail of insults and threats. I don't mind being rejected but he should watch his temper."), #firentis - nizar
  ("npc7_personalityclash2_speech_b", "A battle needs to be properly planned and that plan has to be executed according to the actions of the enemy. {s11} disregards that and I'm concerned that others will follow his example."),#deshavi - rolf
  ("npc8_personalityclash2_speech_b",  "Now put him back in his place lest he tries to take yours. I mean, the boy barely has any fighting experience and thinks he can lead? That's a recipe for disaster."),  #matheld - ymira
  ("npc9_personalityclash2_speech_b", "That said, he is not the reliable kind and will certainly abandon you at the first opportunity. I would advise to get rid of him lest he betrays you or the camp gets infested with all the fleas he seems to attract."),# alayen - marnid
  ...
  ("npc1_personalitymatch_speech", "Hello {lad/lass}. I... forgot what I was going to say. I'm sure it will come back to me in time but while I'm here I think I might put out a good word about {s11}. I know I was... critical of him being with us because he is no warrior, while that is still somewhat true, he has grown on me."),
  ("npc2_personalitymatch_speech", "Captain. I find it surprising that not all Spartans are self-absorbed knobheads. As you might know a detachment of them landed in Taras to help them fend off the Lucanians. The lot I've met certainly thought of themselves as the best warriors that ever lived. One would assume the Lucanians would be no trouble to them right?"),
  ("npc3_personalitymatch_speech", "{s11} fights well. You can promote him if you want."),
  ("npc4_personalitymatch_speech", "{s11} the Gaul, he fights well. With all the bragging he goes on about I expected him to be useless but he can actually fight."),
  ("npc5_personalitymatch_speech", "{s11}, the Etruscan bard. He's very educated and talented I must say."),
  ("npc6_personalitymatch_speech", "I am quite happy that you seem to care to help those in need, take {s11} for instance. He was merely a prisoner of circumstances that he had no say over but now he's a free man thanks to you."),
  ("npc7_personalitymatch_speech", "Appearances can often be deceiving, that's why you need to study your target properly before making a move. Take example of {s11} for instance, he may look like a dim-witted and brutish Thracian but behind that mask is a cunning hunter."),
  ("npc8_personalitymatch_speech", "I have to say, {s11} has grown on me over the time. There's always a bit of a rivalry between Cretans and Rhodians, archers and slingers but in this case it has only been playful. More as a joke than enmity."),
  ("npc9_personalitymatch_speech", "I feel I can sympathise with {s11}, he has been trapped for most of his life and I have felt this way as well."),
  ...
  ("npc1_personalitymatch_speech_b", "He's one of the few souls, other than you of course, that sees the value of my stories and he has been writing them down. I wish I could read properly, but still. I saw that he mentioned me by name which is great, and he often adds that I'm prone to periphrasis. I'm not sure what it means but I'm sure it's a compliment."),
  ("npc2_personalitymatch_speech_b", "Anyway. I just wanted to say that for a Spartan, {s11} is a pretty good lad. He knows better than humiliating a defeated foe and between you and me, exile is probably the best thing that could happen to him. Makes a better man out of him."),
  ("npc3_personalitymatch_speech_b", "I'll still keep an eye on him."),
  ("npc4_personalitymatch_speech_b", "You did well in hiring him. Now I'm curious if he would like to go on a raid, I could use someone like him."),
  ("npc5_personalitymatch_speech_b", "I know he can act strange sometimes... most of the time actually. He does make up to that with his knowledge of Greeks and his talent for poetry."),
  ("npc6_personalitymatch_speech_b", "He's a good lad too and has an interest for the arts and not just warfare. I think you've made a difference in the world by hiring him and I am glad for it."),
  ("npc7_personalitymatch_speech_b", "He plans his raids as I do my hunts and that's not something I say lightly. Most will underestimate him and he will punish them with cunning and deceit, a worthy hunter indeed."),
  ("npc8_personalitymatch_speech_b", "He played along and was a good sport about it, more than I can say for most people that take things personally. Speaking of taking things, have you noticed how he relates everything to hunting? Even courting! There must be some truth to the stories of Cretans and bestiality but I think he's probably messing with us."),
  ("npc9_personalitymatch_speech_b", "Like me, he broke the chains that were holding him back and set out to make a name for himself by his own means. It's simply inspiring don't you think?"),
  ...
  ("npc1_retirement_speech", "I think this might be it for me. I'm not sure what I will do next, but I feel like I had my share of campaigning and that I need to rest my weary bones. Maybe I can find a writer to make a play about my life?"),
  ("npc2_retirement_speech", "I'm getting a bit tired of the warrior's life. I think it's finally time for me to head home and start a family. I thank you for the second chance at life."),
  ("npc3_retirement_speech", "I'm leaving. Maybe I can earn back my place in Sparta."),
  ("npc4_retirement_speech", "We've fought well but I think it's time for me to forge my own path. I hope next time we meet that we're both successful on our journeys."),
  ("npc5_retirement_speech", "It's time for me to take up on new ventures. I never thought of myself as a warrior and I still think my true vocation lies in trading."),
  ("npc6_retirement_speech", "Perhaps this is my chance to try and take my old life back. I appreciate the opportunity you gave me but it's time to part ways, hopefully by the time we meet again, we're both in a better position in life."),
  ("npc7_retirement_speech", "The hunt must go on elsewhere I'm afraid. I enjoyed my time in this pack but I seek new challenges. I heard there are dangerous and exotic animals at the edge of the Seleucid empire, maybe that's where I'm going next."),
  ("npc8_retirement_speech", "I find myself in the same state of mind as when we first met which means I need to move on. I thank you for the opportunity you provided me with but it is time for me to seek new ventures."),
  ("npc9_retirement_speech", "We had some good times so far but I feel like I'm not reaching my goals as fast as I could if I went my own way. I thank you for the opportunity you gave me but I need to take a different path. May we meet again in better times."),
  ("npc10_retirement_speech", "I think I've been out long enough that my former captors have given up on the search, I would very much like to try and reconnect with my family now. Fair travels to you."),
  ("npc11_retirement_speech", "I thank you for letting me come with you but I believe my anger has finally gone away and I think I'm ready to settle in again. If we ever cross paths again I hope I have a new flock by then and that I can offer you some exquisite cheese as a token of my gratitude."),
  ("npc12_retirement_speech", "Some time has passed now and I believe I have a chance to return home. Hopefully the family of the man I accidentally killed have now moved on"),
  ...
  ("npc3_rehire_speech", "They won't take me back in Sparta. Still hiring?"),
  ("npc4_rehire_speech", "I'm still struggling to get started, maybe we're not done yet."),
  ("npc5_rehire_speech", "Hello again {playername}! It's been a while and I must confess that I found myself missing our time together. Maybe I'm not ready yet to put our adventures in the past, if you'll have me of course."),
  ("npc6_rehire_speech", "Good to see you! I think I was wrong to return to my old life, I think the time I spend with you changed me in some ways I can't explain. I still have a passion for the arts and songs but the intrigues of politics don't interest me as much anymore. Not if I can't make a difference. Will you take me back in your company?"),
  ("npc7_rehire_speech", "{playername}. We meet again. My hunt went nowhere I'm afraid. I now despise the deserts and their unending dunes, the scorching sun, the rough and coarse sand that gets everywhere. Maybe it's time we join together for another hunt."),
  ("npc8_rehire_speech", "As I live and breathe, it is you {playername}! I can say that so far nothing was remotely as interesting as the time I spent in your retinue and it has left me wanting more. I think I'm up for more if you'll have me."),
  ("npc9_rehire_speech", "I'm surprised to see you again so soon, perhaps my luck is changing again? I was doing fine for some time but I think I have a thing for attracting crooks and I got fooled again. It's a long story, if you take me along for the road I'll tell you all about it."), #Alayen
  ("npc10_rehire_speech", "Hello {playername}, it has been a short while hasn't it? I've managed to get back home and to be honest, things weren't as I had dreamed during the years. Growing up so far away from my family made them accept that they might never see me again and while they were happy to do so I can't help but feeling I put them at risk. I think it's time for me to get back on the road, perhaps we could go on travelling together again?"),
  ("npc11_rehire_speech", "Captain! I said I was going to settle in again but I'm afraid I've started drinking again instead, I don't think it's time to settle in just yet. I would be glad to join you again if you'll have me."),
  ("npc12_rehire_speech", "Hey {playername}! I was wrong, very wrong. They were still waiting for me and made an attempt on my life as soon as I tried to go back home. It's not safe for me there so maybe we can travel together again."),
...
#local color strings
  ...
  ("npc2_home_intro", "Ah fuck... We're not going to Capua right? I might have been their 'champion' but that doesn't mean some people don't want me dead for running away."),
  ("npc3_home_intro", "That's Sparta. No walls, only men and women. Inside the city are the nobles, the warriors and a select few Periokoi."),
  ("npc4_home_intro", "We're at the frontier of Thrace, Macedonians would say that civilized land stops here but what do they know? They are just afraid to admit we're more alike than what they think."),
  ("npc5_home_intro", "Ah! We are closing in on Taras. One of the few colonies the Spartans ever founded, most people don't even know that but I wouldn't blame them for not knowing. Taras couldn't be more different from Sparta itself."),
  ("npc6_home_intro", "Here lies Tarchuna, the greatest city of the Rasna. Where everyone is your friend but no one really is."),
  ("npc7_home_intro", "Knosós isn't far, you can already see the olive fields and vineyards from here."),
  ("npc8_home_intro", "I didn't think I'd be back in Rhodes anytime soon but it feels good to be back."),
  ("npc9_home_intro", "We're near Tibur, my father's estate lies a few miles outside the city."),
  ("npc10_home_intro", "Oh the joy of walking familiar paths again, I would take this trail with my father when we were going to visit relatives in Phoinike."),
  ("npc11_home_intro", "I see the mountains. We must be getting near my former home."),
  ("npc12_home_intro", "Phársalos! While not exactly a stunning city, its fields are bountiful and the horses bred here are some of the finest of all the Greek world."),
  ...
  ("npc2_home_description", "They might look down on us, which is ironic since we live in the mountains but, there's always two sides to a story. Sure we might partake in the occasional raid on their lands but there's a reason to it... most of the time. Our lands are mostly mountainous which makes it hard to cultivate but at the same time we have large amounts of livestock which we used to trade with the Campanians for other commodities that were hard for us to come by."),
  ("npc3_home_description", "Outside the city are the Helots and Periokoi. The former work the fields that feed the city and the later do the trading and work that is unfit for a Spartan citizen."),
  ("npc4_home_description", "When we raid a village we're the savages but when Alexander burnt cities to the ground he's Alexander the Great. Maybe the problem was that we never burnt or pillaged enough."),
  ("npc5_home_description", "Sparta always enjoyed a reputation for fearsome warriors and a minimalistic lifestyle. Taras is quite the opposite, it's a wealthy city full of merchants and nobles enjoying a life of excess rather than moderation."),
  ("npc6_home_description", "You would think that with the luxuries, all the trade, all the iron and all that gold that the Etruscans would be the sole masters of Italia by now."),
  ("npc7_home_description", "The elders used to say that a great empire used to rule from here and what lies here now is just a pale reflection of it. That the Greeks arrived and built their cities on top of the ruins of the lost empire."),
  ("npc8_home_description", "I was first introduced to the military life when Demetrios besieged the city. All men who were fit to fight were levied to defend the city. I've been using a sling since I was little as were so many youths in Rhodes so a bunch of us were in charge of keeping the enemy away from the walls."),
  ("npc9_home_description", "We produce some wine and grain, grain is grain so it always sells and our wine isn't as popular as the wines from Campania but the prices are affordable."),
  ("npc10_home_description", "This means we must be approaching Dodona, I yearn to set my eyes upon it once again. We should visit the temple of Zeus and the theatre, discretly of course."),
  ("npc11_home_description", "My farm is not far from Elaia, just past the mountain range. The prices here are terrible so I sold the bulk of my wool and cheese in Metapontion instead but it takes a few days to get there."),
  ("npc12_home_description", "My Grandfather served under Philip of Macedon until his death and my father followed Alexander up until after the battle of Hydaspes. He has since retired from service and he taught me how to ride a horse, fight and command."),
  ...
  ("npc3_home_description_2", "The Helots are kept on a tight leash. Spartans often kill a few to keep them servile and prevent a rebellion. I didn't agree with it."),
  ...
  ("npc5_home_description_2", "That said, we're no strangers to war. There were multiple wars and skirmishes with the nearby city-states, some of which were utterly destroyed and no longer exist. There's also the various Italian tribes causing trouble now and then... If they become too much to handle the city calls for Sparta and Sparta answers. Just recently Kleonymos launched an expedition to get rid of some troublesome natives."),
  ("npc6_home_description_2", "The truth is that the cities can't stand each other unless threatened by the same enemies, they simply won't work together otherwise. Even then they might take so long to act that a war is over before it truly begun. They used to have territories deep in the north and the south. The former was recently conquered by migrating Gallic tribes and the later by the Oscans. If the Rasna don't unite under a king as they used to do, it's just a matter of time until their demise."),
  ("npc7_home_description_2", "Things weren't so bad as they are now that most cities are in open conflict to decide who rules over the island. The youth are fooled into fighting pointless wars and are fed lies to keep the war going. In some cities you aren't considered a man until you have taken the life of another man from a rival city. Now you don't wonder why Crete is full of pirates and brigands."),
  ("npc8_home_description_2", "The siege lasted months and Demetrios tried pretty much anything he could to take the city. He mounted siege towers on ships to try and take the lower walls by the sea but we managed to repel him. Later he started building a massive siege tower made of bronze but he lifted the siege before it was completed. We took the siege tower and melted the bronze, the city plans to make a giant statue of Helios to commemorate our victory"),
  ("npc9_home_description_2", "It's not a bad life but it's devoid of prospects. We just managed to stay afloat and our wealth was just enough to not go down the social ladder. I wanted more for myself and our family which is why I left to make a name for myself and for us to be worthy members of the Lucinia gens."),
  ("npc10_home_description_2", "It could well be that my former captors set someone to watch over my family's villa but I would like the chance to see them again anyway."),
  ("npc11_home_description_2", "Elaia is mainly Greek and they don't get along the Lucanians very much, especially after they took over Paiston to the north. I think they used to call it Poseidonia or something."),
  ("npc12_home_description_2", "The rest of my family breeds horses, some for war and some for labor. It's a lucrative business given the quality of the breeds, the Thessalian warhorse is the best you can get."),
  ...
  ("npc3_home_recap", "I lived in Sparta. Not anymore."),
  ("npc4_home_recap", "My home was burnt to the ground."),
  ("npc5_home_recap", "Born and raised in {s21}, a great city for the wealthy or those seeking to become wealthy."),
  ("npc6_home_recap", "I used to live in {s21}."),
  ("npc7_home_recap", "I was born in Crete."),
  ("npc8_home_recap", "I was born in Rhodes."),
  ("npc9_home_recap", "I was born in a small estate not far from Tibur."),
  ("npc10_home_recap", "I was born in Dodona, you must have heard of it if not just because of the oracle."),
  ("npc11_home_recap", "I had a farm near Elaia where I tended a flock of sheep."),
  ("npc12_home_recap", "I'm from Phársalos, how could you even forget that?"),
  ...
  ("npc9_honorific", "captain"), #Alayen
  ("npc10_honorific", "captain"), #Bunduk
  ("npc11_honorific", "captain"), #katrin
  ("npc12_honorific", "captain"),
  ("npc13_honorific", "captain"), #nizar
  ("npc14_honorific", "noble"), #lazalit
  ("npc15_honorific", "captain"), #artimenner
  ("npc16_honorific", "captain"), #klethi

  ("npc1_kingsupport_1", "I don't see why not {lad/lass}. I've seen my fair share of leaders and how they behaved once they got hold of some measure of power. I think with my counsel you may stray from that path of self-destruction and become a wise ruler."), #Borcha
  ("npc2_kingsupport_1", "Well, captain. I'd support you. I think you would treat the people right."), #marnid
  ("npc3_kingsupport_1", "You? Mhm. Alright."), #ymira
  ("npc4_kingsupport_1", "You want to become a chieftain? Well I hope you're not just stealing my ideas but we might be able to help each other."), #rolf
  ("npc5_kingsupport_1", "I see... Maybe this is the opportunity to put into practice some of my ideas for a more open market that in turn benefits the cities."), #beheshtur
  ("npc6_kingsupport_1", "You want to become a king? I think it's a wild idea, if we fail we will be removed from history but if we succeed... Eternal glory is ours, just imagine the songs we could sing about the warrior that would become king!"), #firentis
  ("npc7_kingsupport_1", "You seem certain of yourself but do you know the perils of the road ahead? This is not a simple thing to achieve but nothing is impossible if properly planned. I'll do my part to help."), #deshavi
  ("npc8_kingsupport_1", "Bold move I must say, not that I think you'd make a bad ruler. At least I'm sure you got the war part covered, the ruling part will come to you in time."), #matheld
  ("npc9_kingsupport_1", "Very well captain, despite being born in a Republic I know there is worth in having a good king. Rome certainly had its share of both great and bad kings."), #Alayen
  ("npc10_kingsupport_1", "I am behind you captain, if you promise me one thing, do not tear families apart as no child nor mother deserves to be separated."),#Bunduk
  ("npc11_kingsupport_1", "{King/Queen}? That's mighty ambitious captain. That's much more trouble than tending a flock but know that I will stand by you."), #katrin
  ("npc12_kingsupport_1", "Great warlords can make great kings as well, Alexander certainly proved it. I am confident you will do well for yourself and if you so desire, I could help in gathering support for your cause."), #jeremus
  ...
  ("npc2_kingsupport_2", "A good lot of tribes and peoples are being bullied into submission by stronger nations. Divided they are weak but united under a strong leader they might rise up to the challenge and defy the established powers. If you'll allow me, I'll travel the lands and present you as a champion of the people."), #marnid
  ("npc3_kingsupport_2", "Maybe it's time for a new League. Unite the Poleis against a common foe."), #ymira
  ("npc4_kingsupport_2", "If the Macedonians ever proved anything is that if you set your mind to it you can achieve the impossible. But first you need to prove your strenght and make lesser men bend to your will. I suggest we start there."), #rolf
  ("npc5_kingsupport_2", "I have some ideas on where to get started. If you know the right people and give them the right things, you can put yourself in a position of power. Staying there is the hard part... I think with my support and that of some key characters it's an achievable goal."), #beheshtur
  ("npc6_kingsupport_2", "Yes, Yes. But you need support for your claim and what better to achieve that than some courtly intrigue? Threats, blackmail, bribes and murder. How exciting! We need to be very precise and strike the right people, gather those that would support you and eliminate those who would stand against you. I can arrange to that."), #firentis
  ("npc7_kingsupport_2", "Alright, first thing is to keep your enemies divided and fighting each other while you grow your strenght, don't present yourself as a threat just yet or you will fall before you can even rise. You need to surround yourself with those able to carry your orders and grow your strenght until it can match your enemies. Then you divide and conquer."), #deshavi
  ("npc8_kingsupport_2", "Now if you want support I suggest you start recruiting all the mercenaries you can before your enemies do so. Leave the militias to defend their lands and let the mercenaries win the battles, trust me that the opposite doesn't work. I might have some contacts that could help you get started."), #matheld
  ("npc9_kingsupport_2", "My branch of the Lucinia gens is not very influencial but I can assure you it's not the case for the rest of my family. Some of my distant family still hold considerable political power and might be persuaded to aid you."), #Alayen
  ("npc10_kingsupport_2", "Certainly captain, I think it would be wise to visit the oracle at Dodona so she would tell of your fortune. Her words carry immense weight amongst common and noble folk alike and if fortune favors you, no-one will dare stand in your way."), #Bunduk
  ("npc11_kingsupport_2", "I want to help you but I'm just a humble shepherd. One thing I know though is that marketplace gossip spreads like wildfire and I happen to know just the places where to spread such rumors. If the little people talk much of you, it legitimises your position in the world."), #katrin
  ("npc12_kingsupport_2", "Of course, captain.  You would be wise to show your strenght but not all of it at once, let them fear what you can do and very few would dare stand in your way."), #jeremus
  ...
  ("npc3_kingsupport_2a", "Talk..."), #ymira
  ("npc4_kingsupport_2a", "Alright"),
  ("npc5_kingsupport_2a", "Please go on..."), #beheshtur
  ("npc6_kingsupport_2a", "Splendid"), #firentis
  ("npc7_kingsupport_2a", "Alright..."), #deshavi
  ("npc8_kingsupport_2a", "Fair enough"), #matheld
  ("npc9_kingsupport_2a", "That seems sensible enough..."), #Alayen
  ("npc10_kingsupport_2a", "Of course captain."), #Bunduk
  ("npc11_kingsupport_2a", "Certainly."), #katrin
  ...
  ("npc1_kingsupport_2b", "Well. I did not expect that..."), #Borcha
  ("npc2_kingsupport_2b", "I do not ask for their support, as I don't trust their motives."), #marnid
  ("npc3_kingsupport_2b", "I don't trust them."), #ymira
  ("npc4_kingsupport_2b", "I will have no part of this."), #rolf
  ("npc5_kingsupport_2b", "This sounds like a huge risk."), #beheshtur
  ("npc6_kingsupport_2b", "I'm not sure that I can quite deliver all that"), #firentis
  ("npc7_kingsupport_2b", "This has a great potential for failure"), #deshavi
  ("npc8_kingsupport_2b", "You might want to rethink that"), #matheld
  ...
  ("npc11_kingsupport_2b", "Maybe there's another way."), #katrin
  ("npc12_kingsupport_2b", "I don't think this is quite the right way."), #jeremus
  ...
  ("npc1_kingsupport_3", "I could go around as I said, to gather support from the veterans. By the gods, if you gain support from the Argyraspides you might establish yourself a kingdom from reputation alone a few would dare to go against you. What do you say?"), #Borcha
  ("npc2_kingsupport_3", "If you like, captain, I can take a few weeks to visit the tribes and other peoples that hold a grudge against their oppressors. If they have a leader to unite them, they will certainly be a force to be reckoned with. What do you say captain?"), #marnid
  ("npc3_kingsupport_3", "The poleis will only unite to fight a common enemy. Find an enemy and there rest will fall in place. I can spread the message. If a Spartan is worried about invasion, they will listen."), #ymira
  ("npc4_kingsupport_3", "Well, maybe it's time to make a show of force. We have to take over the weak and divide the strong. If you want I can take care of it, if you strike a nerve you can get great results."),
  ("npc5_kingsupport_3", "Nowadays merchants control the flow of coin and politicians control the narrative. Win the allegiance of both and the rest will fall in place. If you have gold to pay them, the soldiers are happy, if the people believe in their politicians, they too are happy. If you want, I can try and connect all that for you."), #beheshtur
  ("npc6_kingsupport_3", "Good. I will travel the courts in your name, sing your praises and sway the undecided. Gather new friends and eliminate enemies. For that I need to accrue your renown as much as possible, the warrior that would be king, the promised that will stand in the face of injustice and banish the barbarians."), #firentis
  ("npc7_kingsupport_3", "Alright. We need to establish you as the cunning leader that will replace the frail old wolves. Spread dissent amongst your enemies from within, we need to target their people and plant the seed of doubt in their minds. If they can't coordenate, they can't act against you and this will buy you precious time to establish yourself."), #deshavi
  ("npc8_kingsupport_3", "I'll work my contacts and see what I can shake, we need good men by our side if we want to take our share of land. I think once we show that strenght is on our side, some of the disgruntled lords will renounce their rulers and pick your side instead."), #matheld
  ("npc9_kingsupport_3", "I know that speaking of supporting a monarchy of sorts might sound far fetched for most Romans but there's still a few that would have it if the king in question is competent. The senate make its share of mistakes and from the crisis they instigate, dictators are put in power to do what is necessary. We just need to make that position permanent."), #Alayen
  ("npc10_kingsupport_3", "As a Native of Dodona I could seek out a meeting with the oracle in your stead and word of mouth will spread from there."), #Bunduk
  ("npc11_kingsupport_3", "I can travel to some markets spreading the word that a champion of the people rises to free us from tyranny, high taxes and sheep killers. From there, word will quickly spread and some lords will pledge you support if they fear an insurrection from their people."), #katrin
  ("npc12_kingsupport_3", "You know what would give you a tremendous advantage over your rivals? Cavalry. Macedonian influence is decaying and it is only a matter of time until someone challenges its authority, and if it were to be challenged then the peoples it has conquered would certainly rise up to regain their independence or follow someone that would champion it."),
  ...
  ("npc3_kingsupport_objection", "Don't send him, he's an idiot. You will gather enemies instead of allies."),
  ("npc4_kingsupport_objection", "Don't send that senile old man to represent you, I mean, who would even take him seriously? The other nations and tribes will think he just went mad."),
  ("npc5_kingsupport_objection", "Are you really considering sending him? I'm not even sure he can finish a full sentence yet alone convince anyone that you're the one to follow. A grave mistake if you ask me."), #beheshtur
  ("npc6_kingsupport_objection", "This has to be a joke right? Who would even want him anywhere near a court? Can he even tell the difference between a tavern and a court? He will probably gather an army of drunkards and whores instead."), #firentis
  ("npc7_kingsupport_objection", "I don't think songs and courtship will bring you any closer to what you seek to achieve. Recall the bard and take proper action."), #deshavi
  ("npc8_kingsupport_objection", "You sent the shepherd? Seriously? What is he going to do? Rally all the sheep of the land and take down cities with them? Maybe if he hides them well enough he might starve out our enemies haha..."), #matheld
  ("npc9_kingsupport_objection", "You're sending the Thessalian? I'm sure he will talk more of himself than he will of you to the point his audience will end up confused on whom it's supposed to be supporting."), #alayen
  ...
  ("npc1_intel_mission", "Hello {lad/lass}! I've talked to a few veterans that I know in {s17}, we did spend an awful lot of time sharing stories but I assure you that we eventually talked about you. They don't have much to do with their time other than sharing stories and rumours, you know how those go. Anyway, they like you and by now the stories might have spread to {s18}. I could go over there for a few days and tell you how the people are reacting."), #Borcha
  ("npc2_intel_mission", "Captain, if you're interested in events in {s18}. Even if I hate it, I can still make contact with some nobles in {s17}. They're usually well-informed about political events."), #marnid
  ("npc3_intel_mission", "I went to {s17} myself. They declined to take a stance as predicted. Word that a war is coming did travel all over and reached {s18}."), #ymira
  ("npc4_intel_mission", "I can make contact with some of the men in my old raiding party that are hanging around {s17}. They usually roam around {s18} and know a great deal of what's going on there. They will know who and where to strike if we're going to assert ourselves."), #rolf - men whom i fought with
  ("npc5_intel_mission", "I'm working my way though {s17} all the way to {s18}. If all goes well, the pieces will all fall into place and our plan will be successful. I'm working on contingencies just in case."), #beheshtur
  ("npc6_intel_mission", "Despite past issues I can still get in {s17} without much trouble, I would be able to make contact with the ones in power and possibly get rid of a few enemies on the way. This might shift a bit the political balance but with our own people in the court I can easily get information about {s18}."), #firentis
  ("npc7_intel_mission", "I went to {s17}, convinced the people that their leaders were useless and that it was time for a change. I expect the message to spread and the fighting between the cities to cease and become infighting. You can then hope to take the place of some despot and lead them against the remaining ones. I also received some information about {s18}."), #deshavi
  ("npc8_intel_mission", "If you have any interest in the events in the {s18}, a former mercenary and friend of mine retired and now keeps a farm near {s17}. He keeps in contact with a number of company leaders. I could visit him for a few days, and learn more about what is going on there."), #matheld
  ("npc9_intel_mission", "Captain, I've gone to {s17}, I've met with influential members of my gens and if you wish I could gather more information around {s18}."), #Alayen
  ("npc10_intel_mission", "I could go now to {s17}, I would gather support from my family and counsel from the priests of Zeus and if lucky, the oracle. Together they will know what has to be done if you are to be {King/Queen}."), #Bunduk
  ("npc11_intel_mission", "The market of {s17} is a prime location for gossip, some merchant stalls can't help themselves and will spread any rumor you feed them. In turn we can gather some information about what is going on in {s18}, if that would interest you."), #katrin
  ("npc12_intel_mission", "If you wish, Captain, I would not mind taking the time to pay a visit to some friends and companions of mine in {s17}. I know I am not welcome there because of what I did but I should be able to set up a meeting in secrecy and even gather some information about {s18}."), #jeremus
  ...
  ("npc2_fief_acceptance", "You're giving {s17} to me? I've never been much of a leader but I will rise to the occasion. I will do what I can to improve the life of its inhabitants."), #marnid
  ("npc3_fief_acceptance", "I will hold it in your name {playername}. The men will give up their lives to defend it."), #ymira
  ("npc4_fief_acceptance", "So I'm now the chieftain of {s17}? I guess that's what I wanted, I just didn't expect to get it that way. I'm thankful nonetheless."), #rolf
  ("npc5_fief_acceptance", "This is quite a surprise to me! I've managed stalls, ships and caravans but {s17}? I'm quite excited and I hope to rise up to the challenge. I think this will make a great trading post!"), #beheshtur
  ("npc6_fief_acceptance", "All I had at the height of my power was a measly estate. Even with that I managed to organize some incredible org- I mean, feasts. Imagine what I can achieve with this gift of yours? I promise it will be memorable!"), #firentis
  ("npc7_fief_acceptance", "I will treat {s17} like my own pack. Together we will hunt and provide for you, to return the trust you put in me."), #deshavi
  ("npc8_fief_acceptance", "{s17} huh? There hasn't been a city that has fell when defended by sturdy Rhodian warriors, this won't be the exception."), #matheld
  ("npc9_fief_acceptance", "I've thought for a long time that all I would ever own is our miserly estate but your generosity proves otherwise. I will make the best of it, rest assured."), #alayen
  ("npc10_fief_acceptance", "Thank you for the opportunity to rule {s17} for you. I will make sure the people follow you out of love rather than fear."), #bunduk
  ("npc11_fief_acceptance", "{s17}?! This is a big resposability, I can manage a large flock of sheep but people? This is a big step up but I think I'm up for the task, time for me to move up in the world. Thanks {playername} for the vote of confidence."), #katrin
  ("npc12_fief_acceptance", "Thank you captain for this vote of confidence. If you don't mind I will have some of my family members help managing the fief, I don't think the locals will mind me very much but I still want to make sure it is being properly managed."), #jeremus
  ...
  ("npc3_woman_to_woman", "{!}."), #ymira
  ("npc4_woman_to_woman", "{!}."), #rolf
  ("npc5_woman_to_woman", "{!}."), #beheshtur
  ("npc6_woman_to_woman", "{!}."), #firentis
  ("npc7_woman_to_woman", "{!}."), #deshavi
  ("npc8_woman_to_woman", "{!}."), #matheld
  ("npc9_woman_to_woman", "{!}."), #alayen
  ("npc10_woman_to_woman", "{!}."), #bunduk
  ("npc11_woman_to_woman", "{!}."), #katrin
  ("npc12_woman_to_woman", "{!}."), #jeremus
  ("npc13_woman_to_woman", "{!}."), #nizar
  ("npc14_woman_to_woman", "{!}."), #lazalit
  ("npc15_woman_to_woman", "{!}."), #artimenner
  ("npc16_woman_to_woman", "{!}."), #klethi

  ("npc1_turn_against", "Well there {lad/lass}... We have shared many stories, so it breaks my heart that the tides turned us enemies. If any story comes from this, it will certainly be a tragic one."), #Borcha
  ("npc2_turn_against", "This is a sad day. Once again has fate decided that I would have to fight those I once considered my kin. I hoped this would never happen again but here we are."), #marnid
  ("npc3_turn_against", "We meet as enemies. I promise to make it quick."), #ymira
  ("npc4_turn_against", "No hard feelings {playername}, sometimes it's just the way things go. May the strongest win."), #beheshtur  
  ("npc5_turn_against", "I've had some nasty rivalries in Taras but I never thought to turn against an old friend. There's no words that I could say that would make this situation less worse. Let's get done with it."), #rolf
  ...
  ("npc7_turn_against", "We each lead our own packs now and have to fight for contested territory. I wish it would be otherwise but that's the way of life."), #deshavi
  ("npc8_turn_against", "One of the downside of being a mercenary is that any day you might end up fighting a former friend or comrade. Today is one of those days and as much as I would like to look the other way, I simply can't. I promise this is not personal my friend."), #matheld
  ("npc9_turn_against", "Fate has a way of turning brothers against brothers doesn't it? There is no satisfaction in this fight, let it be over quickly."), #alayen
  ("npc10_turn_against", "These are strange times we are in, not so long ago I would have considered you as a {brother/sister} and would gladly have traded my life for yours. Yet today we face each other in a cruel twist of fate. I can't make excuses for either of us, let's get over with this."), #bunduk
  ("npc11_turn_against", "I'm truly sorry for the circumstances that have led to this but the gods seem to play their cruel games on me."), #katrin
  ("npc12_turn_against", "War is war my friend and we do what we must to survive. As the Diadochs turned on each other to ensure their survival, I shall turn on you in this day."), #jeremus
...
#courtship
  ...
  ("kingdom_1_adjective",                     "Romani"),
  ("kingdom_2_adjective",                     "Hellenikoi"),
  ("kingdom_3_adjective",                     "Gallikoi"),
  ("kingdom_4_adjective",                     "Makedonikoi"),
  ("kingdom_5_adjective",                     "Samnitici"),
  ("kingdom_6_adjective",                     "Tarentinoi"),
  ("kingdom_7_adjective",                     "Syrakosioi"),  
  ("kingdom_8_adjective",                     "Epeirotai"),
  ("kingdom_9_adjective",                     "Razna"),
...
#multiplayer scene names
  ("multi_scene_1", "[S] Roman Camp"), # Morning
  ("multi_scene_2", "[S] Arena"), # Afternoon
  ("multi_scene_3", "[S] Roman Villa"), # Morning
  ("multi_scene_4", "[S] Ostia"), # Morning
  ("multi_scene_5", "[S] Gallic Mounds"), # Night
  ("multi_scene_6", "[S] Gallic Village"), # Morning
  ("multi_scene_7", "[S] Phocian Walls"), # Afternoon
  ("multi_scene_8", "[S] The Crossing"), # Night and rain 
 ...
 # RaW
  ...
  ("multi_scene_32", "Battle of the Mounds"),     
  ("multi_scene_33", "Gallic Forest Fort"),    
  ("multi_scene_34", "Celtic Village"),    
  ("multi_scene_35", "Troy"),    
  ("multi_scene_36", "Chaeronea"), 
  ("multi_scene_37", "Forest"),   
  ("multi_scene_38", "The Crossing"),   
  ("multi_scene_39", "The Arena"),   
  ("multi_scene_40", "Dark Forest"),     
  ("multi_scene_41", "Alpine Fort"),  
  ("multi_scene_42", "Swamp"),    
  ("multi_scene_43", "Siege of Lugdunum"),
...
#multiplayer game type names
  ...
  ("extra_encumbrance", "Enable extra encumbrance"),
  ("fog", "Enable random fog chance"),
  ...
  ("extra_encumbrance_on", "Extra Encumbrance is On."), # RaW
  ("extra_encumbrance_off", "Extra Encumbrance is Off."), # RaW
  ("fog_on", "Fog is On."), # RaW
  ("fog_off", "Fog is Off."), # RaW  
...
##diplomacy end+
  ...
  #Faction descriptors
  ("swadians", "Romani"),
  ("vaegirs", "Koinon Hellenon"),
  ("khergits", "Gallia"),
  ("nords", "Makedonia"),
  ("rhodoks", "Samnium"),
  ("sarranids", "Tarentinoi"),
  ("syracusan", "Syrakosioi"),  
  ("epeirote", "Epeiros"),    
  ("etruscan", "Razna"),   
  ("bandits", "bandits"),
  ("deserters", "deserters"),
...
##diplomacy end+
  ...
  ("you_speak_of_unifying_calradia_well_youve_done_a_good_job_at_making_calradia_bend_its_knee_to_you_so_maybe_thats_not_just_talk", "You speak of unifying the world. Well, you've done a good job at making Calradia bend its knee to you, so maybe that's not just talk."),
  ("you_speak_of_unifying_calradia_id_be_impressed_if_i_thought_you_could_do_it_but_unfortunately_you_dont", "You speak of unifying the world. I'd be impressed if I thought you could do it. But unfortunately, you don't."),
...
#  ("you_speak_of_unifying_calradia_well_maybe_you_can_unite_this_land_by_the_sword_but_im_not_sure_that_this_will_make_you_a_good_ruler", "You speak of unifying the world. Well, maybe you can unite this land by the sword. But I'm not sure that this will make you a good ruler."),
  ("you_speak_of_unifying_calradia_well_maybe_you_can_unite_this_land_by_the_sword_but_im_not_sure_that_this_will_make_you_a_good_ruler", "You speak of unifying the world. Well, maybe you can unite this land by the {s14}. But I'm not sure that this will make you a good ruler."),
...
#reg3 refers to the gender of the lord being spoken about, reg65 is the speaker's
  ...
  ("appears_to_value_me_with_is_estate_and_his_horse_as_prizes_worth_aving", "appears to value me with {reg3?her:his} estate and {reg3?her:his} horse as prizes worth having"),
...
#diplomacy end+
  ...
  ("ah_kais_and_layali__such_a_sad_tale_many_a_time_has_it_been_recounted_for_my_family_by_the_wandering_poets_who_come_to_our_home_and_it_has_never_failed_to_bring_tears_to_our_eyes", "Ah -- 'Kais and Layali' -- such a sad tale. Many a time has it been recounted for my family by the wandering poets who come to our home, and it has never failed to bring tears to our eyes."),
  ...
  ("the_saga_of_helgered_and_kara_such_appy_times_in_which_our_ancestors_lived_women_like_kara_could_venture_out_into_the_world_like_men_win_a_name_for_themselves_and_not_linger_in_their_husbands_shadow", "The saga of 'Helgered and Kara'? Such happy times in which our ancestors lived! Women like Kara could venture out into the world like men, win a name for themselves, and not linger in their husbands' shadow."),
  ...
  ("may_face_some_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords", "may face some difficulties establishing yourself as an equal among the world's great lords"),
  ("may_face_great_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords", "may face great difficulties establishing yourself as an equal among the world's great lords"),
...
##diplomacy end+
  ...
  ("party_with_commander_mismatch_check_log_for_details_", "Party with commander mismatch - check log for details "),
  ("s4_adds_wealth_as_reg4_wealth_accumulated", "{!}{s4} adds wealth, has {reg4} wealth accumulated"),
...
##diplomacy end+
  ...
  ("bah_im_in_no_mood_for_whispering_in_the_corner", "Bah -- I'm in no mood for whispering in the corner."),
  ...
  ("that_you_are_the_rightful_heir_to_the_throne_of_calradia", "That you are the rightful king of the world?"),
  ...
  ("khan", "khan"),
  ("i", "I"),
  ("according_to_the_ancient_law_and_custom_of_the_calradians_s45_should_be_s47", "According to the ancient law and custom of the country, {s45} should be {s47}"),
...
#  ("talk_is_for_heralds_and_lawyers_real_kings_prove_themselves_with_their_swords", "Talk is for heralds and lawyers. Real kings prove themselves with their swords."),
  ...
  ("very_well_an_alliance_with_you_could_be_valuable_go_chat_with_er_and_see_if_you_can_get_her_to_take_a_fancy_to_you_if_she_doesnt_and_if_we_still_want_to_conclude_this_business_then_i_can_make_her_see_reason", "Very well. An alliance with you could be valuable. Go chat with her, and see if you can get her to take a fancy to you. If she doesn't, and if we still want to conclude this business, then I can make her see reason."),
...
##diplomacy start+ gender correction
  ("you_plan_to_marry_s4_as_you_have_no_family_in_calradia_he_will_organize_the_wedding_feast", "You plan to marry {s4}. As you have no family in the country, {she/he} will organize the wedding feast."),
##diplomacy end+
...
##diplomacy start+ make gender correct
  ...
  ("you_intend_to_challenge_s13_to_force_him_to_relinquish_is_suit_of_s11", "You intend to challenge {s13} to force {reg4?her:him} to relinquish his suit of {s11}."),
##diplomacy end+
  ("farewell", "Farewell."),
...
##diplomacy start+ fix pronoun with reg4
  ("_has_been_asking_around_for_someone_who_might_want_work_id_watch_yourself_with_im_though", " has been asking around for someone who might want work. I'd watch yourself with {reg4?her:him}, though."),
##diplomacy end+
  ("town", "town."),
  ("castle", "castle."),
...
##diplomacy end+
  ...
  ("s12there_is_a_feast_of_the_s3_in_progress_at_s4_which_as_only_just_begun_", "{s12}There is a feast of the {s3} in progress at {s4}, which has only just begun. "),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_player", "King {s0}"),
  ("faction_title_male_1", "Socii {s0}"),
  ("faction_title_male_2", "Xenologos {s0}"),
  ("faction_title_male_3", "Valos {s0}"),
  ("faction_title_male_4", "Archon {s0}"),
  ("faction_title_male_5", "Meddix {s0}"),
  ("faction_title_male_6", "Xenologos {s0}"),
  ("faction_title_male_7", "Xenologos {s0}"),
  ("faction_title_male_8", "Xenologos {s0}"),  
  ("faction_title_male_9", "Zilath {s0}"),  

  ("faction_title_female_player", "Lady {s0}"),
  ("faction_title_female_1", "Socii {s0}"),
  ("faction_title_female_2", "Xenologos {s0}"),
  ("faction_title_female_3", "Valos {s0}"),
  ("faction_title_female_4", "Xenologos {s0}"),
  ("faction_title_female_5", "Meddix {s0}"),
  ("faction_title_female_6", "Xenologos {s0}"),
  ("faction_title_female_7", "Xenologos {s0}"),
  ("faction_title_female_8", "Xenologos {s0}"),
  ("faction_title_female_9", "Zilath {s0}"),
...
##diplomacy end+
  ...
  ("quick_battle_troop_1", "Gokiller, former leader of RaW is back for you to control"),
  ("quick_battle_troop_2", "Alexander the Great, a military genius and great warrior. Leader and creator of the famous Companion Cavalry."),
  ("quick_battle_troop_3", "Rgcotl, do I need to say more?"),
  ("quick_battle_troop_4", "Seek n Destroy, because he can."),
  ("quick_battle_troop_5", "KickingJoub, the Athenian drill sergeant, mess with him and you'll end up face on the floor."),
  ("quick_battle_troop_6", "Gothic, a full member of the Sacred band of Thebes (Tee-hee)"),
  ("quick_battle_troop_7", "The all mighty Theretor, he will try to cheer you up before slaughtering you and will leave humming ''Don't worry be happy''. It can't get more sadistic than this."),
...
("adimi_tool_eat_food", "You restored 5HP by eating {s1}."),
...
("adimi_tool_punishment_reason_4", "Running away like a bitch"),

...
meshes = [
  ...
  ("pic_arms_taras", 0, "pic_arms_taras", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_syracuse", 0, "pic_arms_syracuse", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_epeiros", 0, "pic_arms_epeiros", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_etruscan", 0, "pic_arms_etruscan", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  # ("tableau_mesh_eraldic_armor_a", 0, "tableau_mesh_eraldic_armor_a",  0, 0, 0, 0, 0, 0, 1, 1, 1),
  # ("tableau_mesh_eraldic_armor_b", 0, "tableau_mesh_eraldic_armor_b",  0, 0, 0, 0, 0, 0, 1, 1, 1),
  # ("tableau_mesh_eraldic_armor_c", 0, "tableau_mesh_eraldic_armor_c",  0, 0, 0, 0, 0, 0, 1, 1, 1),
  # ("tableau_mesh_eraldic_armor_d", 0, "tableau_mesh_eraldic_armor_d",  0, 0, 0, 0, 0, 0, 1, 1, 1),

  # ("outer_terrain_plain_1", 0, "ter_border_a", -90, 0, 0, 0, 0, 0, 1, 1, 1),
 ("outer_terrain_plain_1", 0, "message_window", -90, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("ui_kingdom_shield_rebel", 0, "ui_kingdom_shield_rebel", 0, 0, 0, 0, 0, 0, 1, 1, 1),
...
# RaW Begin
  ("mp_ui_maps_new_a1", 0, "mp_ui_maps_new_a1", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_a2", 0, "mp_ui_maps_new_a2", 0, 0, 0, 0, 0, 0, 1, 1, 1),   
  ("mp_ui_maps_new_a3", 0, "mp_ui_maps_new_a3", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_a4", 0, "mp_ui_maps_new_a4", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_b1", 0, "mp_ui_maps_new_b1", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_b2", 0, "mp_ui_maps_new_b2", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_b3", 0, "mp_ui_maps_new_b3", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_b4", 0, "mp_ui_maps_new_b4", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_c1", 0, "mp_ui_maps_new_c1", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_c2", 0, "mp_ui_maps_new_c2", 0, 0, 0, 0, 0, 0, 1, 1, 1),   
  ("mp_ui_maps_new_d1", 0, "mp_ui_maps_new_d1", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_d2", 0, "mp_ui_maps_new_d2", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_d3", 0, "mp_ui_maps_new_d3", 0, 0, 0, 0, 0, 0, 1, 1, 1), 
  ("mp_ui_maps_new_d4", 0, "mp_ui_maps_new_d4", 0, 0, 0, 0, 0, 0, 1, 1, 1),   
  ("mp_ui_maps_new_e1", 0, "mp_ui_maps_new_e1", 0, 0, 0, 0, 0, 0, 1, 1, 1),    
  ("mp_ui_maps_new_e2", 0, "mp_ui_maps_new_e2", 0, 0, 0, 0, 0, 0, 1, 1, 1),   
  ("mp_ui_maps_new_e3", 0, "mp_ui_maps_new_e3", 0, 0, 0, 0, 0, 0, 1, 1, 1),   
  ("mp_ui_maps_new_e4", 0, "mp_ui_maps_new_e4", 0, 0, 0, 0, 0, 0, 1, 1, 1),     
##diplomacy begin
